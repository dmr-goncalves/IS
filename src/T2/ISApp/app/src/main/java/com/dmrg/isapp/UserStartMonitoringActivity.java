...
public class UserStartMonitoringActivity extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
    EditText etName;
    Button bRegister;
    String ipAddress;
    String port = "3000";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_start_monitoring_device);

        mToolbar = (Toolbar) findViewById(R.id.startMonDev_nav_action);
        setSupportActionBar(mToolbar);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.startMon_DrawerUser);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.startMon_nav_view);
        ...
        etName = (EditText) findViewById(R.id.user_startMon_devName);


        bRegister = (Button) findViewById(R.id.user_startMon_button);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.user_startMon_button:
                if (isEmpty(etName)) {
                    ...
                    String uri = "http://" + ipAddress + ":" + port + "/api/mobile/device/reMonitorDevice";
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.toString()) {
            case "Home":
                Intent mainIntent1 = new Intent(UserStartMonitoringActivity.this, UserMainActivity.class);
                ...
                UserStartMonitoringActivity.this.startActivity(mainIntent1);
                UserStartMonitoringActivity.this.finish();
                break;

            case "Register Device":
                Intent mainIntent2 = new Intent(UserStartMonitoringActivity.this, UserRegisterDeviceActivity.class);
                ...
                UserStartMonitoringActivity.this.startActivity(mainIntent2);
                UserStartMonitoringActivity.this.finish();
                break;

            case "Unregister Device":
                Intent mainIntent3 = new Intent(UserStartMonitoringActivity.this, UserUnregisterDevice.class);
                ...
                UserStartMonitoringActivity.this.startActivity(mainIntent3);
                UserStartMonitoringActivity.this.finish();
                break;

            case "Remove Device":
                Intent mainIntent4 = new Intent(UserStartMonitoringActivity.this, UserRemoveDeviceActivity.class);
                ...
                UserStartMonitoringActivity.this.startActivity(mainIntent4);
                this.mDrawerLayout.closeDrawer(GravityCompat.START);
                break;

            case "Check Devices History":
                /*Intent mainIntent4 = new Intent(UserStopMonitoringActivity.this, UserCheckDeviceHistory.class);
                ...
                UserStopMonitoringActivity.this.startActivity(mainIntent4);
                UserStopMonitoringActivity.this.finish();*/
                Pass = Toast.makeText(getApplicationContext(), "In future patches", Toast.LENGTH_SHORT);
                Pass.show();
                break;

            case "Check Personal History":
                Intent mainIntent5 = new Intent(UserStartMonitoringActivity.this, UserCheckHistory.class);
                ...
                UserStartMonitoringActivity.this.startActivity(mainIntent5);
                UserStartMonitoringActivity.this.finish();
                break;

            case "Logoff":
                Intent mainIntent6 = new Intent(UserStartMonitoringActivity.this, UserLogoutActivity.class);

                mainIntent6.putExtra("username", username);
                mainIntent6.putExtra("ip", ipAddress);

                UserStartMonitoringActivity.this.startActivity(mainIntent6);
                UserStartMonitoringActivity.this.finish();
                break;

            case "Stop Monitoring Device":
                Intent mainIntent7 = new Intent(UserStartMonitoringActivity.this, UserStopMonitoringActivity.class);
                ...
                mainIntent7.putExtra("devices", devices);
                mainIntent7.putExtra("ip", ipAddress);

                UserStartMonitoringActivity.this.startActivity(mainIntent7);
                UserStartMonitoringActivity.this.finish();
                break;
        }
        return true;
