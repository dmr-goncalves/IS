...
public class ProducerUnregisterDeviceModel extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_producer_unregister_device_model);

        mToolbar = (Toolbar) findViewById(R.id.producer_unRegDevModel_nav_action);
        setSupportActionBar(mToolbar);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.un_reg_dev_model_drawerProducer);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.producer_un_reg_dev_model_nav_view);
        ...
        etDevName = (EditText) findViewById(R.id.producer_unRegDevModel_devName);
        etDeviceId = (EditText) findViewById(R.id.producer_unRegDevModel_devName);

        bRegister = (Button) findViewById(R.id.producer_unRegDevModel_button);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.toString()) {
            case "Home":
                Intent mainIntent1 = new Intent(ProducerUnregisterDeviceModel.this, ProducerMainActivity.class);
                ...
                ProducerUnregisterDeviceModel.this.startActivity(mainIntent1);
                ProducerUnregisterDeviceModel.this.finish();
                break;

            case "Register Device Type":
                Intent mainIntent2 = new Intent(ProducerUnregisterDeviceModel.this, ProducerRegisterDeviceType.class);
                ...
                ProducerUnregisterDeviceModel.this.startActivity(mainIntent2);
                ProducerUnregisterDeviceModel.this.finish();
                break;

            case "Remove Device Type":
                Intent mainIntent3 = new Intent(ProducerUnregisterDeviceModel.this, ProducerUnregisterDeviceType.class);
                ...
                ProducerUnregisterDeviceModel.this.startActivity(mainIntent3);
                ProducerUnregisterDeviceModel.this.finish();
                break;

            case "Register Device Model":
                Intent mainIntent4 = new Intent(ProducerUnregisterDeviceModel.this, ProducerRegisterDeviceModel.class);
                ...
                ProducerUnregisterDeviceModel.this.startActivity(mainIntent4);
                ProducerUnregisterDeviceModel.this.finish();
                break;
            ...
            case "Check User Activity":
                Intent mainIntent7 = new Intent(ProducerUnregisterDeviceModel.this, ProducerCheckGivenUserHistory.class);
                ...
                ProducerUnregisterDeviceModel.this.startActivity(mainIntent7);
                ProducerUnregisterDeviceModel.this.finish();
                break;

            case "Logoff":
                Intent mainIntent8 = new Intent(ProducerUnregisterDeviceModel.this, ProducerLogoutActivity.class);

                mainIntent8.putExtra("ip", ipAddress);
                mainIntent8.putExtra("username", username);

                ProducerUnregisterDeviceModel.this.startActivity(mainIntent8);
                ProducerUnregisterDeviceModel.this.finish();
                break;
        }
        return true;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.producer_unRegDevModel_button:
                ...
                if (isEmpty(etDevName) || isEmpty(etDeviceId)) {
                    ...
                    String uri = "http://" + ipAddress + ":" + port + "/api/mobile/producer/productmodel/remove";
    ...
    private class HttpRequestAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (requestReply.equalsIgnoreCase("Product Model Not Found")) {
                toast = Toast.makeText(context, "Product Model Not Found", Toast.LENGTH_SHORT);
                toast.show();
            } else if (requestReply.equalsIgnoreCase("Failed To Remove Product Model")) {
                toast = Toast.makeText(context, "Failed To Remove Device Model", Toast.LENGTH_SHORT);
                toast.show();
                ...
                try {
                    ...
                    toast = Toast.makeText(context, "Device Model Was Successfully Removed", Toast.LENGTH_SHORT);
                    toast.show();
