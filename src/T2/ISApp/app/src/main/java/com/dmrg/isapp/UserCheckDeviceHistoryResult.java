...
public class UserCheckDeviceHistoryResult extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    String ipAddress;
    String port = "3000";
    Toast Pass;
    String username, name, devices, date, email, password, requestReply;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_check_device_history_result);

        mToolbar = (Toolbar) findViewById(R.id.user_checkDevH_res_nav_action);
        setSupportActionBar(mToolbar);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.check_dev_h_res_drawerUser);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.user_check_dev_h_res_nav_view);
        ...
        ListView lv;
        lv = (ListView) findViewById(R.id.user_DeviceHistoryList);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.toString()) {
            case "Register Device":
                Intent mainIntent1 = new Intent(UserCheckDeviceHistoryResult.this, UserRegisterDeviceActivity.class);
                ...
                UserCheckDeviceHistoryResult.this.startActivity(mainIntent1);
                this.mDrawerLayout.closeDrawer(GravityCompat.START);
                //UserMainActivity.this.finish();
                break;

            case "Stop Monitoring Device":
                Intent mainIntent2 = new Intent(UserCheckDeviceHistoryResult.this, UserStopMonitoringActivity.class);
                ...
                UserCheckDeviceHistoryResult.this.startActivity(mainIntent2);
                UserCheckDeviceHistoryResult.this.finish();
                break;

            case "Start Monitoring Device":
                Intent mainIntent3 = new Intent(UserCheckDeviceHistoryResult.this, UserStartMonitoringActivity.class);
                ...
                UserCheckDeviceHistoryResult.this.startActivity(mainIntent3);
                this.mDrawerLayout.closeDrawer(GravityCompat.START);
                //UserMainActivity.this.finish();
            ...
            case "Unregister Device":
                Intent mainIntent4 = new Intent(UserCheckDeviceHistoryResult.this, UserUnregisterDevice.class);
                ...
                UserCheckDeviceHistoryResult.this.startActivity(mainIntent4);
                this.mDrawerLayout.closeDrawer(GravityCompat.START);
                break;

            case "Remove Device":
                Intent mainIntent5 = new Intent(UserCheckDeviceHistoryResult.this, UserRemoveDeviceActivity.class);
                ...
                UserCheckDeviceHistoryResult.this.startActivity(mainIntent5);
                this.mDrawerLayout.closeDrawer(GravityCompat.START);
                break;

            case "Check Devices History":
                /*Intent mainIntent8 = new Intent(UserCheckDeviceHistoryResult.this, UserCheckDeviceHistory.class);
                ...
                UserCheckDeviceHistoryResult.this.startActivity(mainIntent8);
                UserCheckDeviceHistoryResult.this.finish();*/
            ...
            case "Check Personal History":
                Intent mainIntent6 = new Intent(UserCheckDeviceHistoryResult.this, UserCheckHistory.class);
                ...
                UserCheckDeviceHistoryResult.this.startActivity(mainIntent6);
                this.mDrawerLayout.closeDrawer(GravityCompat.START);
                break;

            case "Logoff":
                Intent mainIntent7 = new Intent(UserCheckDeviceHistoryResult.this, UserLogoutActivity.class);

                mainIntent7.putExtra("ip", ipAddress);
                mainIntent7.putExtra("username", username);

                UserCheckDeviceHistoryResult.this.startActivity(mainIntent7);
                UserCheckDeviceHistoryResult.this.finish();
                break;
        }
        return true;
