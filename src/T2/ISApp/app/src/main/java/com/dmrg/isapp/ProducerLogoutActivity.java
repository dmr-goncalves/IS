...
public class ProducerLogoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ipAddress.length() > 0 && port.length() > 0) {
            ...
            String uri = "http://" + ipAddress + ":" + port + "/api/mobile/producer/logout";
    ...
    private class HttpRequestAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (requestReply.equalsIgnoreCase("Producer Was Not Logged In")) {
                toast = Toast.makeText(context, "Producer Was Not Logged In", Toast.LENGTH_SHORT);
                toast.show();
            } else if (requestReply.contains("refused")) {
                toast = Toast.makeText(context, "Connection Refused", Toast.LENGTH_SHORT);
                toast.show();
            } else if(requestReply.equalsIgnoreCase("Producer Successfully Logged Off")){
                ...
                Intent mainIntent = new Intent(ProducerLogoutActivity.this, LoginActivity.class);

                ProducerLogoutActivity.this.startActivity(mainIntent);
                finish();
            }
        }
