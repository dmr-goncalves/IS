...
public class ProducerRegisterDeviceType extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_producer_register_device_type);

        mToolbar = (Toolbar) findViewById(R.id.producer_regDevType_nav_action);
        setSupportActionBar(mToolbar);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.reg_dev_type_drawerProducer);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.producer_reg_dev_type_nav_view);
        ...
        etDevName = (EditText) findViewById(R.id.producer_regDevType_devName);
        etDeviceId = (EditText) findViewById(R.id.producer_regDevType_devName);

        bRegister = (Button) findViewById(R.id.producer_regDevType_button);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.toString()) {
            case "Home":
                Intent mainIntent1 = new Intent(ProducerRegisterDeviceType.this, ProducerMainActivity.class);
                ...
                ProducerRegisterDeviceType.this.startActivity(mainIntent1);
                ProducerRegisterDeviceType.this.finish();
                break;

            case "Remove Device Type":
                Intent mainIntent2 = new Intent(ProducerRegisterDeviceType.this, ProducerUnregisterDeviceType.class);
                ...
                ProducerRegisterDeviceType.this.startActivity(mainIntent2);
                ProducerRegisterDeviceType.this.finish();
                break;

            case "Register Device Model":
                Intent mainIntent3 = new Intent(ProducerRegisterDeviceType.this, ProducerRegisterDeviceModel.class);
                ...
                ProducerRegisterDeviceType.this.startActivity(mainIntent3);
                ProducerRegisterDeviceType.this.finish();
                break;

            case "Remove Device Model":
                Intent mainIntent4 = new Intent(ProducerRegisterDeviceType.this, ProducerUnregisterDeviceModel.class);
                ...
                ProducerRegisterDeviceType.this.startActivity(mainIntent4);
                ProducerRegisterDeviceType.this.finish();
                break;
            ...
            case "Check User History":
                Intent mainIntent7 = new Intent(ProducerRegisterDeviceType.this, ProducerCheckGivenUserHistory.class);
                ...
                ProducerRegisterDeviceType.this.startActivity(mainIntent7);
                ProducerRegisterDeviceType.this.finish();
                break;

            case "Logoff":
                Intent mainIntent8 = new Intent(ProducerRegisterDeviceType.this, ProducerLogoutActivity.class);

                mainIntent8.putExtra("ip", ipAddress);
                mainIntent8.putExtra("username", username);

                ProducerRegisterDeviceType.this.startActivity(mainIntent8);
                ProducerRegisterDeviceType.this.finish();
                break;
        }
        return true;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.producer_regDevType_button:
                ...
                if (isEmpty(etDevName) || isEmpty(etDeviceId)) {
                    ...
                    String uri = "http://" + ipAddress + ":" + port + "/api/mobile/producer/devicetype/add";
    ...
    private class HttpRequestAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (requestReply.equalsIgnoreCase("Device Type Already Exists")) {
                toast = Toast.makeText(context, "Device Type Already Exists", Toast.LENGTH_SHORT);
                toast.show();
            } else if (requestReply.equals("Failed To Register Device Type")) {
                toast = Toast.makeText(context, "Failed To Register Device Type", Toast.LENGTH_SHORT);
                toast.show();
                ...
                try {
                    ...
                    toast = Toast.makeText(context, "Device Type Was Successfully Registered", Toast.LENGTH_SHORT);
                    toast.show();
