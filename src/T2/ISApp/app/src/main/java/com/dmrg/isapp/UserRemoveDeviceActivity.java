...
public class UserRemoveDeviceActivity extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
    EditText etName;
    Button bRemove;
    String ipAddress;
    String port = "3000";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_remove_device);

        mToolbar = (Toolbar) findViewById(R.id.removeDev_nav_action);
        setSupportActionBar(mToolbar);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.user_removeDev_drawer);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.user_removeDev_nav_view);
        ...
        tv.setText(username);
        etName = (EditText) findViewById(R.id.user_removeDev_devName);


        bRemove = (Button) findViewById(R.id.user_removeDev_button);
        bRemove.setOnClickListener(this);
    }

    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.user_removeDev_button:
                if (isEmpty(etName)) {
                    ...
                    String uri = "http://" + ipAddress + ":" + port + "/api/mobile/device/removeDevice";
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.toString()) {
            case "Home":
                Intent mainIntent1 = new Intent(UserRemoveDeviceActivity.this, UserMainActivity.class);
                ...
                UserRemoveDeviceActivity.this.startActivity(mainIntent1);
                UserRemoveDeviceActivity.this.finish();
                break;


            case "Register Device":
                Intent mainIntent2 = new Intent(UserRemoveDeviceActivity.this, UserRegisterDeviceActivity.class);
                ...
                UserRemoveDeviceActivity.this.startActivity(mainIntent2);
                UserRemoveDeviceActivity.this.finish();
                break;

            case "Stop Monitoring Device":
                Intent mainIntent3 = new Intent(UserRemoveDeviceActivity.this, UserStopMonitoringActivity.class);
                ...
                UserRemoveDeviceActivity.this.startActivity(mainIntent3);
                UserRemoveDeviceActivity.this.finish();
                break;
            ...
            case "Check Personal History":
                Intent mainIntent5 = new Intent(UserRemoveDeviceActivity.this, UserCheckHistory.class);
                ...
                UserRemoveDeviceActivity.this.startActivity(mainIntent5);
                UserRemoveDeviceActivity.this.finish();
                break;

            case "Logoff":
                Intent mainIntent6 = new Intent(UserRemoveDeviceActivity.this, UserLogoutActivity.class);

                mainIntent6.putExtra("username", username);
                mainIntent6.putExtra("ip", ipAddress);

                UserRemoveDeviceActivity.this.startActivity(mainIntent6);
                UserRemoveDeviceActivity.this.finish();
                break;

            case "Start Monitoring Device":
                Intent mainIntent8 = new Intent(UserRemoveDeviceActivity.this, UserStartMonitoringActivity.class);
                ...
                UserRemoveDeviceActivity.this.startActivity(mainIntent8);
                UserRemoveDeviceActivity.this.finish();
                break;
        }
        return true;
    ...
    private class HttpRequestAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (requestReply.contains("refused")) {
                ...
                toast.show();
            } else if (requestReply.equalsIgnoreCase("User Doesn't Have That Device")) {
                toast = Toast.makeText(context, "User Doesn't Have That Device", Toast.LENGTH_SHORT);
                toast.show();
            } else {
                try {
