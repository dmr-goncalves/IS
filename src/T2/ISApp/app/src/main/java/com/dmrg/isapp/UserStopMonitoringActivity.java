...
public class UserStopMonitoringActivity extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
    EditText etName;
    Button bRegister;
    String ipAddress;
    String port = "3000";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_stop_monitoring);

        mToolbar = (Toolbar) findViewById(R.id.stopMonDev_nav_action);
        setSupportActionBar(mToolbar);
        mDrawerLayout = (DrawerLayout) findViewById(R.id.stopMon_DrawerUser);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.stopMon_nav_view);
        ...
        etName = (EditText) findViewById(R.id.user_stopMon_devName);


        bRegister = (Button) findViewById(R.id.user_stopMon_button);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.toString()) {
            case "Home":
                Intent mainIntent1 = new Intent(UserStopMonitoringActivity.this, UserMainActivity.class);
                ...
                UserStopMonitoringActivity.this.startActivity(mainIntent1);
                UserStopMonitoringActivity.this.finish();
                break;

            case "Register Device":
                Intent mainIntent2 = new Intent(UserStopMonitoringActivity.this, UserRegisterDeviceActivity.class);
                ...
                UserStopMonitoringActivity.this.startActivity(mainIntent2);
                UserStopMonitoringActivity.this.finish();
                break;

            case "Unregister Device":
                Intent mainIntent3 = new Intent(UserStopMonitoringActivity.this, UserUnregisterDevice.class);
                ...
                UserStopMonitoringActivity.this.startActivity(mainIntent3);
                UserStopMonitoringActivity.this.finish();
                break;

            case "Remove Device":
                Intent mainIntent4 = new Intent(UserStopMonitoringActivity.this, UserRemoveDeviceActivity.class);
            ...
            case "Check Personal History":
                Intent mainIntent5 = new Intent(UserStopMonitoringActivity.this, UserCheckHistory.class);
                ...
                UserStopMonitoringActivity.this.startActivity(mainIntent5);
                UserStopMonitoringActivity.this.finish();
                break;

            case "Logoff":
                Intent mainIntent6 = new Intent(UserStopMonitoringActivity.this, UserLogoutActivity.class);

                mainIntent6.putExtra("username", username);
                mainIntent6.putExtra("ip", ipAddress);

                UserStopMonitoringActivity.this.startActivity(mainIntent6);
                UserStopMonitoringActivity.this.finish();
                break;

            case "Start Monitoring Device":
                Intent mainIntent8 = new Intent(UserStopMonitoringActivity.this, UserStartMonitoringActivity.class);
                ...
                UserStopMonitoringActivity.this.startActivity(mainIntent8);
                UserStopMonitoringActivity.this.finish();
                break;
        }
        return true;
