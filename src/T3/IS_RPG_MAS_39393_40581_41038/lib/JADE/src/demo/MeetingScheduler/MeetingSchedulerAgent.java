 ...
 * @version $Date: 2004-07-19 17:09:07 +0200 (lun, 19 lug 2004) $ $Revision:
 * 5215 $
 */
public class MeetingSchedulerAgent extends GuiAgent {
    ...
    /**
     * This method is executed by the Agent thread when the GUI posts a new
     * Event
     *
     */
    ...
    /**
     * This method returns an Enumeration of String. Each String is the name of
     * a DF with which the agent has been registered
     */
    ...
    /**
     * This method returns an Enumeration of objects. The object type is Person
     */
    ...
    private void fixAppointment(Appointment a) {
        ...
        if (ag.size() == 0) {//there is only me, nobody invited. Just find a free day
            ...
            if (fillAppointmentWithPossibleDates(a)) // if returns True than there are available dates
            {
    ...
    /**
     * This function fills the Appointment with all the dates when this user is
     * available
     *
