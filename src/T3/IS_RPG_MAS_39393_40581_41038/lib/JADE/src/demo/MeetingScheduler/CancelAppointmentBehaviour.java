 ...
 * @version $Date: 2003-03-19 16:07:33 +0100 (mer, 19 mar 2003) $ $Revision:
 * 3843 $
 */
public class CancelAppointmentBehaviour extends CyclicBehaviour {
    ...
    public void action() {
        ...
        try {
            ...
            if (app.getInviter().equals(myAgent.getAID())) // I called the appointment and I have to inform other agents of that
            {
