...
/**
 *
 * This class defines the necessary information for the configuration properties
 * of JADE. For every property some information are necessary to show the
 * correctly: the name, the type (integer, boolean or string), the default
 * Value, , the string to show as tooltip in the gui at start up and a boolean
 * to indicate if the property is mandatory or not.
 *
