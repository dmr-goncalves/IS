...
public class SimpleSLTokenizer {
    ...
    /**
     * Return the next SL token (i.e. '(', ')' or a generic element) without
    ...
    /**
     * Check that the next character (after eventual spaces) is 'c' and advance
     * the pointer to the character just after
     */
    ...
    /**
     * Return the next SL element (i.e. a word or a generic sequence of char
     * enclosed into "") and advance the pointer to the character just after. If
     * the element starts with ':' this is automatically removed. If the element
     * is a sequence of char enclosed into "" the enclosing " are removed and
     * all \" are automatically transformed into "
     */
     ...
     * In addition to FIPA's restrictions, place the additional restriction that
     * a Word can not contain a '\"', that would confuse the parser at the other
     * end.
     */
    ...
    /**
     * Take a java String and quote it to form a legal FIPA SL0 string. Add
