...
/**
 * This facet forces the elements in an AbsAggregate to be compliant to a given
 * schema.
 *
...
public class TypedAggregateFacet implements Facet {
    ...
    /**
     * Construct a <code>TypedAggregateFacet</code> that forces the elements in
     * an AbsAggregate to be instances of a given schema
     */
