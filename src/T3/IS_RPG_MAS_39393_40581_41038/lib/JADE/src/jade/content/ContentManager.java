...
public class ContentManager implements Serializable {
    ...
    /**
     * Registers a <code>Codec</code> for a given content language with its
     * default name (i.e. the name returned by its <code>getName()</code>
     * method. Since this operation is performed the agent that owns this
     * <code>ContentManager</code> is able to "speak" the language corresponding
     * to the registered <code>Codec</code>.
     *
     ...
     * performed the agent that owns this <code>ContentManager</code> "knows"
     * the registered <code>Ontology</code>.
     *
     ...
     * <code>name</code>.
     *
     * @param name the name associated to the <code>Codec</code> to be
     * retrieved.
     ...
     * <code>name</code>.
     *
     * @param name the name associated to the <code>Ontology</code> to be
     * retrieved.
    ...
    /**
     * Fills the <code>:content</code> slot of an <code>ACLMessage msg</code>
     * using the content language and ontology indicated in the
     * <code>:language</code> and <code>:ontology</code> fields of
     * <code>msg</code>.
     *
     ...
     * <code>ACLMessage msg</code> into an <code>AbsContentElement</code> using
     * the content language and ontology indicated in the <code>:language</code>
     * and <code>:ontology</code> fields of <code>msg</code>.
     *
    ...
    /**
     * Translates the <code>:content</code> slot of an
     * <code>ACLMessage msg</code> into a <code>ContentElement</code> using the
     * content language and ontology indicated in the <code>:language</code> and
     ...
     * managed by this content manager should be validated during message
     * content filling/extraction. Default value is <code>true</code>
     *
    ...
    /**
     * Merge the reference ontology with the inner ontology of the content
     * language
     */
