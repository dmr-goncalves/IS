...
/**
 * An Abstract descriptor that can hold an Identifying Referential Expression
 * (IRE). Note that an IRE is both a content element (as in the case of a
 * QUERY-REF communicative act) and a Term (as in the case of (== (X) (iota ?x
 * P(?x))
 *
...
public class AbsIRE extends AbsObjectImpl implements AbsContentElement, AbsTerm {
     ...
     * ANY, IOTA, ALL...).
     *
     * @param typeName The name of the type of the IRE held by this abstract
     * descriptor.
     */
     ...
     *
     * @param variables The abstract descriptor holding the sequence of
     * variables.
     */
     ...
     *
     * @param t The abstract descriptor holding the variable or sequence of
     * variables.
     */
     ...
     *
     * @return the abstract descriptor holding the sequence of variables of this
     * IRE.
     */
     ...
     * <code>false</code>. Infact an IRE always includes a variable.
     */
