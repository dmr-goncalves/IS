...
/**
 * This class implements an ontology containing schemas for Primitive types and
 * SL0 operators i.e. basic ontological elements required for minimal agent
 * interaction. Users should always extend this ontology when defining their
 * ontologies.
 *
...
public class BasicOntology extends Ontology implements SL0Vocabulary {
    ...
    /**
     * This method is redefined as BasicOntology does not use an Introspector
    ...
    /**
     * Redefine the <code>getSchema()</code> method to take into account ACL
     * performatives.
     *
    ...
    /**
     * Redefine the <code>getSchema()</code> method to take into account java
     * primitives.
     *
    ...
    /**
     * Note that we don't want to keep 22 different schemas for the 22 FIPA
     * communicative acts --> We generate the schemas for communicative acts on
     * the fly as needed.
     */
    ...
    //#MIDP_EXCLUDE_BEGIN
    /**
     * Convert, if possible, the numeric value srcValue into an instance of
     * destClass
     */
