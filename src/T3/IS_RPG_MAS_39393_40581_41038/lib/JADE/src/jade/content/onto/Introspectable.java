...
/**
 * This interface must be implemented by ontological classes that belong to an
 * ontology using the <code>MicroIntrospector</code>. It includes methods by
 * means of which an object can be converted into/from an abstract descriptor.
 *
...
public interface Introspectable {
     ...
     *
     * @param abs The abstract descriptor this object must externalise itself
     * into.
     ...
     *
     * @param abs The abstract descriptor this object must internalise itself
     * from
     * @param onto The reference ontology
