...
public class AbsObjectImpl implements AbsObject {
     ...
     * @param value The new value of the attribute. If <code>value</code> is
     * null the current mapping with <code>name</code> (if any) is removed.
     */
    ...
    /**
     * Returns true if the attribute is equal to this abstract descriptor, based
     * on the contents of both descriptors.
     */
    ...
    /**
     * Calculates the hashcode according to a formula based on the slot names
     * and values taken in an lexicographical order
     */
