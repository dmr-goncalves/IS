...
/**
 * SLParser. This same parser embeds also lower profiles of SL, namely SL-0,
 * SL-1 and SL-2.
 *
 * @author Fabio Bellifemine, TILab S.p.A. (formerly CSELT S.p.A.)
 * @author Nicolas Lhuillier (Motorola) (added support for
 * PREFIXBYTELENGTHENCODEDSTRING)
 * @version $Date: 2008-08-19 12:09:12 +0200 (mar, 19 ago 2008) $ $Revision:
 * 6041 $
 *
 */
class SLParser implements SLParserConstants {
    ...
    /**
     * When an ActionExpression is parsed, if it is an AbsConcept then it must
     * be casted upto an AbsAgentAction.
     *
     */
    ...
    /**
     * By default an object of this type implements a Full SLParser. This method
     * allows to change this default.
     *
     ...
     * @param o the ontology, null if no ontology (this parameter is used to get
     * the names of the slots when they are encoded as unnamed slots.
     */
     ...
     * @param o the ontology, null if no ontology (this parameter is used to get
     * the names of the slots when they are encoded as unnamed slots.
     * @deprecated since JADE 3.4 it is preferrable to use reinit() and then
     * call directly the method corresponding to the production rule (e.g.
     * Content())
     */
     ...
     * serve as content for an ACL message. Since different communicative acts
     * have different content (action expressions for <code>request</code>,
     * predicate for <code>inform</code>, etc.), any allowed SL content
     * expression can be parsed from here.
     */
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            ...
            case STRING_LITERAL2:
                ...
                if (CaseInsensitiveString.equalsIgnoreCase(s, "true")) {
                    ...
                    if ((CaseInsensitiveString.equalsIgnoreCase(s, "\u005c"true\u005c""))
                            || (CaseInsensitiveString.equalsIgnoreCase(s, "\u005c"false\u005c""))) // in this case leading/trailing quotes were added by the
    ...
    final public AbsPredicate Wff_NoBrace() throws ParseException {
        AbsPredicate arg1, arg2, val = null;
        Token t;
        AbsTerm term;
        String s;
        String slotNames[] = null;
    ...
    /**
     * <p>
     * <code> String = WORD | STRING_LITERAL </code>
     */
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            ...
            case STRING_LITERAL2:
                ...
                if ((CaseInsensitiveString.equalsIgnoreCase(t.image, "\u005c"true\u005c""))
                        || (CaseInsensitiveString.equalsIgnoreCase(t.image, "\u005c"false\u005c""))) // in this case leading/trailing quotes must be left
    ...
    /**
     * This grammar rule is an extension to the FIPA SL Grammar. It is specific
     * to the semantics framework. It allows to represent a symbol which is not
     * matched by any FIPA-SL token. *
     */
