...
public class AbsContentElementList implements AbsContentElement {
    ...
    /**
     * Add a new element (that must be a content element) to this content
     * element list.
     *
    ...
    /**
     * @return An <code>Iterator</code> over the elements of this content
     * element list.
     */
    ...
    /**
     * Test if a given content element is contained in this content element
     * list.
     *
     * @return <code>true</code> if the given content element is contained in
     * this content element list.
     */
     ...
     *
     * @return The position of an element within this content element list or -1
     * if the given element is not contained in this content element list.
     */
     ...
     *
     * @return <code>true</code> if this content element list does not contain
     * any element.
     */
    ...
    /**
     * Retrieve all elements in this content element list in the form of an
     * array.
     *
    ...
    /**
     * @return The name of the type of the object held by this abstract
     * descriptor.
    ...
    /**
     * Makes no sense in the case of an AbsContentElementList that has no
     * attribute --> Just return null
     */
