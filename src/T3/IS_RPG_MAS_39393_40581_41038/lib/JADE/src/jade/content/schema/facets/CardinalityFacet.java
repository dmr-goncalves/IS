...
/**
 * This facet forces an AbsAggregate to contain a number of elements that is
 * comprised between a given min and a given max.
 *
...
public class CardinalityFacet implements Facet {
    ...
    /**
     * Construct a <code>CardinalityFacet</code> that forces the number of
     * elements in an AbsAggregate to be within a given range
     *
    ...
    /**
     * Check that the number of elements in an AbsAggregate is within a given
     * range
     *
