...
public class AbsVariable extends AbsObjectImpl implements AbsTerm {
     ...
     * @param valueType The type of values that can be assigned to this
     * variable.
     *
     */
    ...
    /**
     * Return true if this object represents a meta term (i.e. symbol ??x)
     * rather than a concrete variable. This method is currently used only by
