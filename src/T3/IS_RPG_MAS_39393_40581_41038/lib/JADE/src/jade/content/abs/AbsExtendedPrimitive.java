 ...
 * java.math.BigDecimal) not supported by <code>AbsPrimitive</code>.
 */
public class AbsExtendedPrimitive implements AbsTerm {
    ...
    /**
     * Construct an extended abstract descriptor to hold a primitive of the
     * proper type (e.g. java.math.BigDecimal...) and set its value.
     */
    ...
    /**
     * Construct an Abstract descriptor to hold a extended-primitive of the
     * proper type (e.g. java.math.BigInteger...).
     *
    ...
    /**
     * Makes no sense in the case of an AbsExtendedPrimitive that has no
