...
/**
 * Indicates the aggregate result of an action, allowing at the same time to
 * specify its <code>cardMin</code> (minimum cardinality), <code>cardMax</code>
 * (maximum cardinality) and <code>type</code> (class of the contained
 * elements).<br>
