...
/**
 * MIDP implementation of the SLCodec. Actually the MIDP version of the SLCodec
 * just extends SimpleSLCodec
 *
 * @version $Date: 2013-02-25 11:10:22 +0100 (lun, 25 feb 2013) $ $Revision:
 * 6642 $
 *
 */
public class SimpleSLCodec extends StringCodec {
     ...
     * parsing, empty slots can only occur at the end.
     */
     ...
     * non-empty slot the slot name followed by the slot value.
     */
    ...
    /**
     * Decodes a content expression to an abstract description using a given
     * ontology.
     *
     * @param ontology the ontology.
