...
public class AggregateHelper {
    ...
    /**
     * Try to convert, if possible, the aggregate value srcValue into an
     * instance of destClass Possible source and destination classes are java
     * array, java collection and jade collection
     *
     * @throws Exception
     */
