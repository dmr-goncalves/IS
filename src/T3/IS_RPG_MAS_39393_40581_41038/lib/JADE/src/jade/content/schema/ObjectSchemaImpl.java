...
class ObjectSchemaImpl extends ObjectSchema {
     ...
     * and <code>cardMax</code> to this schema and allow specifying the type of
     * Aggregate to be used for this slot.
     *
     * @param name The name of the slot.
     * @param elementsSchema The schema for the elements of this slot.
    ...
    /**
     * Add a super schema to this schema, i.e. this schema will inherit all
     ...
     * defined in this <code>Schema</code>
     *
    ...
    /**
     * For each slot - get the corresponding attribute value from the abstract
     * descriptor abs - Check that it is not null if the slot is mandatory -
     * Check that its schema is compatible with the schema of the slot - Check
     * that it is a correct abstract descriptor by validating it against its
     * schema.
     */
    ...
    /**
     * Validate a given abstract descriptor as a value for a slot defined in
     * this schema
     *
     * @param slotName The name of the slot
     * @param value The abstract descriptor to be validated
     * @throws OntologyException If the abstract descriptor is not a valid value
     * @return true if the slot is defined in this schema (or in one of its
     * super schemas). false otherwise
     */
    ...
    /**
     * Return true if s is a super-schema (directly or indirectly) of this
     * schema
     */
     ...
     * all facets defined in this schema plus all facets defined in
