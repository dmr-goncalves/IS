 ...
 * concept <code>Man</code> as a refinement of the concept <code>Person</code>:  <code>
...
public class Ontology implements Serializable {
    ...
    /**
     * Construct an Ontology object with a given <code>name</code> that extends
     * a given ontology. The <code>ReflectiveIntrospector</code> is used by
     * default to convert between Java objects and abstract descriptors.
     *
    ...
    /**
     * Construct an Ontology object with a given <code>name</code> that uses a
     * given Introspector to convert between Java objects and abstract
     * descriptors.
     *
     * @param name The identifier of the ontology.
    ...
    /**
     * Construct an Ontology object with a given <code>name</code> that extends
     * a given ontology and that uses a given Introspector to convert between
    ...
    /**
     * Construct an Ontology object with a given <code>name</code> that extends
     * a given set of ontologies and that uses a given Introspector to convert
     * between Java objects and abstract descriptors.
     *
     * @param name The identifier of the ontology.
     * @param base The base ontology.
     * @param introspector The introspector.
    ...
    /**
     * Retrieves the schema associated to a given class in this ontology. The
     * search is extended to the base ontologies if the schema is not found.
     *
     * @param clazz the class whose associated schema must be retrieved.
     * @return the schema associated to the given class or <code>null</code> if
     ...
     * @return the Java class or null if no schema called <code>name</code> is
     * found or if no class is associated to that schema.
    ...
    /**
     * Retrieves the ontology actually containing the definition of a given
     * schema. This can be the ontology itself or one of its super-ontologies.
     *
     * @param lcName The lower-case version of the name of the schema whose
     * defining ontology must be retrieved
     * @return The ontology actually containing the definition of schema
     * <code>lcName</code> or null if such schema is not defined neither in this
     * ontology nor in one of its super-ontologies
     */
     ...
     * aconverted into lower case. This is passed as parameters to avoid making
     * the conversion to lower case for each base ontology.
    ...
    /**
     * Internalize (abs --> obj) the slots defined in <code>schema</code> and
     * its super-schemas
     */
    ...
    /**
     * Externalize (obj --> abs) the slots defined in <code>schema</code> and
     * its super-schemas
     */
    ...
    /**
     * Retrieve the value of slot <code>slotName</code> from object
     * <code>obj</code>
     */
    ...
    /////////////////////////
    /**
     * Check whether a given object is a valid term. If it is an Aggregate (i.e.
     * a <code>List</code>) it also check the elements.
     *
    ...
    //#J2ME_EXCLUDE_BEGIN
    /**
     * Retrieve the names of the concepts defined in this ontology only
     * (excluding extended ontologies). It should be noticed that an
     * agent-action is itself a concept and therefore the returned list also
     * includes names of agent-actions defined in this ontology.
     * <br>
     * <b>NOT available in J2ME</b>
     * <br>
     *
     * @return the names of the concepts defined in this ontology only
     ...
     * extended ontologies). It should be noticed that an agent-action is itself
     * a concept and therefore the returned list also includes names of
     * agent-actions defined in this ontology.
     * <br>
     * <b>NOT available in J2ME</b>
     * <br>
     *
    ...
    /**
     * Retrieve the names of all agent actions defined in this ontology
     * (including extended ontologies).
     * <br>
     * <b>NOT available in J2ME</b>
     * <br>
     *
     * @return the names of all agent actions defined in this ontology
     * (including extended ontologies)
     */
    ...
    /**
     * Retrieve the names of the predicates defined in this ontology only
     * (excluding extended ontologies).
     * <br>
     * <b>NOT available in J2ME</b>
     * <br>
     *
     * @return the names of the predicates defined in this ontology only
     * (excluding extended ontologies)
     */
     ...
     * ConceptSlotFunction class allows treating the slots of an ontological
     * concept as functions. For instance, if an ontology defines a concept
     ...
     * This method must be invoked after all schemas have been completely
     * defined and added to this ontology.
     *
     * @see ConceptSlotFunction
