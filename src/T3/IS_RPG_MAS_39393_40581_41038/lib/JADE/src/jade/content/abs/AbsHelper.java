...
public class AbsHelper {
    ...
    /**
     * Converts a <code>List</code> into a <code>AbsAggregate</code> using the
     * specified ontology.
     *
    ...
    /**
     * Converts a <code>Set</code> into a <code>AbsAggregate</code> using the
     * specified ontology.
     *
    ...
    /**
     * Converts an <code>AID</code> into an <code>AbsConcept</code> representing
     * an AID
     *
     ...
     * <code>AbsContentElementList</code> using the specified ontology.
     *
    ...
    /**
     * Converts an <code>ACLMessage</code> into an <code>AbsAgentAction</code>
    ...
    /**
     * Converts an <code>AbsAggregate</code> into a List using the specified
     * ontology.
     *
     * @param onto the ontology
     * @return the List
    ...
    /**
     * Converts an <code>AbsAggregate</code> into a Set using the specified
     * ontology.
     *
     * @param onto the ontology
     * @return the Set
    ...
    /**
     * Converts an <code>AbsConcept</code> representing an AID into an OntoAID
     *
     * @return the OntoAID
     * @throws OntologyException if <code>aid</code> does not represent a valid
     * AID
     */
     ...
     * ContentElementList using the specified ontology.
     *
     * @param onto the ontology
    ...
    /**
     * Set an attribute in an abstract descriptor performing all necessary type
     * checks.
     *
    ...
    /**
     * Recursively removes prefix (if present) from abs-type-name, except for
     * BasicOntology types Prefix is identified from last separator string Eg.
     * A.B.C -> C (if separator is .)
     *
    ...
    /**
     * Return true if the abs-object is a template. A template is an abs with
     * all slots AbsVariable or AbsAggregate empty
     *
    ...
    /**
     * Apply default value to template Replace node with default value only if
     * the value in template is null or AbsVariable or default value is null and
     * template is a true template
     *
    ...
    /**
     * Generate an AbsObject consistently with schema. All variables are
     * prefixed
     *
     * @param schema to convert
