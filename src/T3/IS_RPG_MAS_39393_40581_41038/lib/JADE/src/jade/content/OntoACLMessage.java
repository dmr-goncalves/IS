...
public class OntoACLMessage extends ACLMessage implements AgentAction {
     ...
     *
     * @param msg the <code>ACLMessage</code>to be wrapped. If <code>msg</code>
     * is already an ontological ACL message no new object is created and
     * <code>msg</code> is returned with the sender and receivers properly
    ...
    /**
     * This method is redefined so that the sender AID is automatically wrapped
     * into an OntoAID
     */
