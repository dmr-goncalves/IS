...
/**
 * Generic class representing all frames (such as concepts and predicates) whose
 * composing elements can be retrieved by a unique name.
 *
...
public class QualifiedFrame extends Hashtable implements Frame {
    ...
    /**
     * Redefine the put() method so that keys must be String and setting a null
     * value for a given key is interpreted as removing the entry.
     *
    ...
    /**
     * Utility method to put a value of type <code>int</code> in this Frame.
     */
    ...
    /**
     * Utility method to put a value of type <code>boolean</code> in this Frame.
     */
