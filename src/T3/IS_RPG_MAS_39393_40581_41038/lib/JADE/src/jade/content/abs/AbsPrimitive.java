...
public class AbsPrimitive implements AbsTerm {
    ...
    /**
     * Construct an Abstract descriptor to hold a primitive of the proper type
     * (e.g. String, int, boolean...) and set its value.
     */
     ...
     *
     * @param typeName The name of the type of the primitive held by this
     * abstract descriptor.
     */
    ...
    /**
     * Create an AbsPrimitive of type <code>BasicOntology.DATE</code> containing
     * a given <code>Date</code> value.
     */
