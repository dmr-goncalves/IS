...
/**
 * This class extends the AppletRequestProto in order to send a request for a
 * FIPA Action.
 *
 * @author Tiziana Trucco - CSELT S.p.A.
 * @version $Date: 2003-02-25 13:29:42 +0100 (mar, 25 feb 2003) $ $Revision:
 * 3687 $
 */
public class FIPAAppletRequestProto extends AppletRequestProto {
    ...
    /**
     * Constructor of the class. It creates the request message accoding to the
     * action specified.
     *
    ...
    public void handleInform(ACLMessage msg) {
        ...
        try {
            if (this.action.equalsIgnoreCase(FIPAManagementVocabulary.REGISTER)) {    // refresh the gui
            ...
            } else if (this.action.equalsIgnoreCase(FIPAManagementVocabulary.SEARCH)) { //extract the results and  update the gui
                try {
