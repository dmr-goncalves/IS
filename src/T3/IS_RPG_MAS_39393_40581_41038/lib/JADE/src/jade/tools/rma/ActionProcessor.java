 ...
 * @version $Date: 2006-06-05 13:19:41 +0200 (lun, 05 giu 2006) $ $Revision:
 * 5885 $
 */
    ...
    public void process(RMAAction a) {
        ...
        // means that, if no selection is present, no action is performed.
            ...
            if (paths != null) {
                ...
                } else if (action instanceof DummyAgentAction || action instanceof SnifferAction || action instanceof IntrospectorAction || action instanceof LogManagerAgentAction) {
                    containerAct(null);
                } else if (action instanceof PlatformAction) {
