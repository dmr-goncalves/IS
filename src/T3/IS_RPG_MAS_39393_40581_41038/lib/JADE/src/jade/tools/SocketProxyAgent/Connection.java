...
class Connection extends Thread {
     ...
     * messages from the stream. For each message it gets from the input stream
     * it 1) sends it into the Jade world and 2) starts a new behavior to wait
     * for the response. When that behavior gets the response (or times out) it
     * will send a message back out the socket.
     */
    public void run() {
