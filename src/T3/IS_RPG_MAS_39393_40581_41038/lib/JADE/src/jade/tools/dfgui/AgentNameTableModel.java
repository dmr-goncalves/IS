...
/**
 * This class extends the AbstractTableModel to provide an appropriate model for
 * the table used to display agents in the gui of the DF.
 *
    ...
    public Object getValueAt(int row, int column) {
        ...
        switch (column) {
            ...
            case 1:
                ...
                break;
            case 2:
                for (Iterator i = aid.getAllResolvers(); i.hasNext();) {
                    try {
