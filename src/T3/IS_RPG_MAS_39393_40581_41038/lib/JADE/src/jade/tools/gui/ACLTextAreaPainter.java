 ...
 * of text.The original file is written by Slava Pestov (www.gjt.org) and
...
public class ACLTextAreaPainter extends JComponent implements TabExpander {
    ...
    /**
     * Marks a range of lines as needing a repaint, but doesn't actually repaint
     * them until <code>repaint()</code> is called.
     *
     ...
     * <code>newFirstLine</code> by shifting the offscreen graphics and
     * repainting any revealed lines. This should not be called directly; use
     * <code>JEditTextArea.setFirstLine()</code> instead.
     *
