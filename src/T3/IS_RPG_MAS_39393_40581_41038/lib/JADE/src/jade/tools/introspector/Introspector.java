...
public class Introspector extends ToolAgent {
     ...
     * messages from ToolNotifiers informing that they have started notifying
     * events about a given agent. These information are used to keep the map
     * between observed agents and ToolNotifiers up to date.
     */
     ...
     * while it is debugging the AMS a deadlock occurs. In fact, while exiting,
     * the Introspector can't make the debugged agents proceed. At the same time
     * however the Introspector can't proceed as it is waiting for the answer to
     * its AMS deregistration
     */
     ...
     * <li> If the character in the expression token isn't equal to the
     * character in the subject string they don't match.
     * </ol>
     ...
     * start debugging agents. If an agent does not exist it is put into the
