...
/**
 * This class extends the AppletRequestProto in order to request the df for an
 * applet action.
 *
 * @author Tiziana Trucco - CSELT S.p.A.
 * @version $Date: 2003-08-26 11:37:47 +0200 (mar, 26 ago 2003) $ $Revision:
 * 4252 $
 */
public class JADEAppletRequestProto extends AppletRequestProto {
     ...
     * @param parentDF the df to wich request an action (used for federate
     * action)
     */
