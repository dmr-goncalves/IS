...
/**
 * Agent to bridge ACL messages between JADE and the outside using a socket. The
 * agent(s) to talk to and the port to be used may be specified:
 * <ol>
 ...
 * <ol>
 * <li>agent arguments: argument 0 is port number, argument 1 legal addressee
 * agents</li>
 * <li>configuration file: line 0 is port number, line 1 legal addressee
 * agents</li>
 * </ol>
 * Specifying an asterisk (<code>*</code>) for the agents will permit all agents
 * to be legal addressees.
 *
