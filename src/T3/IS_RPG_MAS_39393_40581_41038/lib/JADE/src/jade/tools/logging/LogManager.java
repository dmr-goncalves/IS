...
public interface LogManager {
    ...
    /**
     * Returns a list of <code>LoggerInfo</code> objects each one describing a
     * logger active in the local JVM.
     *
    ...
    /**
     * Returns a list of <code>LevelInfo</code> object each one describing a
     * level valid for the selected logging system.
     *
     * @return a list of <code>LevelInfo</code> object each one describing a
     * level valid for the selected logging system.
     */
