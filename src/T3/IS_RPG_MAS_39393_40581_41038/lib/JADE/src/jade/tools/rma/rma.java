 ...
 * <b>JADE</b> <em>RMA</em> agent. <b>JADE</b> applications cannot use this
 * class directly, but interact with it through <em>ACL</em>
 * message passing. Besides, this agent has a <em>GUI</em> through which
 * <b>JADE</b> Agent Platform can be administered.
 *
 *
...
public class rma extends ToolAgent {
    ...
    /**
     * This method starts the <em>RMA</em> behaviours to allow the agent to
     * carry on its duties within <em><b>JADE</b></em> agent platform.
     */
