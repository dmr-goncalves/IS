...
/**
 * This is a panel, with a top part containing state buttons and a bottom part
 * containing some action buttons. It allows to manage the state of an agent.
 *
 * @author Giovanni Rimassa, Andrea Squeri, Corti Denis, Ballestracci Paolo -
 * Universita` di Parma
 *
 */
