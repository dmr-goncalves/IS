...
/**
 * The TimeChooser class can be used to let the user define a certain point in
 * time by means of a dialog window. Used for for filling the reply-by attribute
 * of an ACL.
 *
