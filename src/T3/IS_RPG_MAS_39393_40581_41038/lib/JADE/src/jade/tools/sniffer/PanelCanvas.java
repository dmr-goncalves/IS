 ...
 */
/**
 * Makes the two canvas.One is the agent canvas which is useful for drawing the
 * agent's box and other is the message canvas which useful for drawing the
 * message with blue arrows.
 *
 * @see jade.tools.sniffer.MainPanel
 */
public class PanelCanvas
        //#DOTNET_EXCLUDE_BEGIN
        extends JPanel //#DOTNET_EXCLUDE_END
/*#DOTNET_INCLUDE_BEGIN
	extends Panel
	#DOTNET_INCLUDE_END*/ {
