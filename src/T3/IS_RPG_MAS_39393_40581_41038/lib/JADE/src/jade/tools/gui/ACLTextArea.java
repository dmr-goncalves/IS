...
/**
 * jEdit's text area component. The original file is written by Slava Pestov and
...
//    msg.deleteObserver(this);
    ...
    private static class InputHandler implements KeyListener {
        ...
        /**
         * Adds a key binding to this input handler. The key binding is a list
         * of white space separated key strokes of the form
         * <i>[modifiers+]key</i>
         * where modifier is C for Control, A for Alt, or S for Shift, and key
         * is either a character (a-z) or a field name in the KeyEvent class
