 ...
 * @version $Date: 2002-12-13 14:34:24 +0100 (ven, 13 dic 2002) $ $Revision:
 * 3529 $
 */
/**
 * AbstractPopup is the superclass of the actions performed by PopupMenu on the
 * Canvas.
 *
 * This class is abstract because it does not define the
 * ActionPerformed(ActionEvent evt) method. In every subClass of AbstractPopup
