...
/**
 * This class is invoked the the user selects the AboutBox item on the menu. A
 * dialog box appears providing informations about the authors and program
 * version of the Introspector agent.
 *
