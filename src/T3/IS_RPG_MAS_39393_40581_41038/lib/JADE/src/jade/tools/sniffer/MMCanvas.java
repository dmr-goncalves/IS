 ...
 * @version $Date: 2010-03-22 14:34:52 +0100 (lun, 22 mar 2010) $ $Revision:
 * 6288 $
 * @version $Date: 2010-03-22 14:34:52 +0100 (lun, 22 mar 2010) $ Modified by RR
 * Kessler and ML Griss
 * @version $Date: 2010-03-22 14:34:52 +0100 (lun, 22 mar 2010) $ Mofified by ML
 * Griss - 3 line folding
 */
/**
...
public class MMCanvas
        //#DOTNET_EXCLUDE_BEGIN
        extends JPanel implements MouseListener, MouseMotionListener, Serializable //#DOTNET_EXCLUDE_END
{
    ...
    /* To resize and modify the scroll bars */
  ...
  #DOTNET_INCLUDE_END*/
    //#DOTNET_EXCLUDE_BEGIN
    public void paintComponent(Graphics g) //#DOTNET_EXCLUDE_END
    /*#DOTNET_INCLUDE_BEGIN
  ...
  #DOTNET_INCLUDE_END*/ {
   ...
   #DOTNET_INCLUDE_END*/
    ...
    /**
     * Method invoked everytime the use clicks on a blue arrow: it updates the
     * TextMessage component displaying the type of the message.
     *
  ...
  #DOTNET_INCLUDE_END*/
    ...
    //#DOTNET_EXCLUDE_BEGIN
    /**
     * This method is invoked every time a user double-click on a blue arrow in
     * the message canvas: the double-click occurs on a blue arrow in the
     * message canavs, a dialog box is displayed with the entire message.
     *
     * @param evt mouse event
     */
 ...
 #DOTNET_INCLUDE_END*/
    ...
    /**
     * Removes all the agents and messages from their lists then repaints the
     * canvas
     */
    ...
    /**
     * Returns an handler to the agent list. The agent list contains all the
     * agents contained in the Agent Canvas displayed by grey or red boxes
     *
    ...
    /**
     * Set the agent list handler as the parameter passed then repaints the
     * canvas
     *
    ...
    /**
     * Set the message list handler as the parameter passed then repaints the
     * canvas
     *
