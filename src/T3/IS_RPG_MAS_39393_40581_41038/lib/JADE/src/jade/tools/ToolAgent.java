 ...
 * @version $Date: 2009-05-18 17:12:10 +0200 (lun, 18 mag 2009) $ $Revision:
 * 6124 $
 */
public abstract class ToolAgent extends Agent {
    ...
    /**
     * This method is invoked just after the generic agent setup. Subclasses
    ...
    /**
     * Retrieve the <code>subscribe</code> ACL message with which this tool
     * agent subscribed with the AMS.
     *
