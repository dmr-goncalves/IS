 ...
 * @version $Date: 2004-04-06 11:39:40 +0200 (mar, 06 apr 2004) $ $Revision:
 * 4967 $
 */
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (name != null) {
            if (kind == DFGUI.AGENT_VIEW || kind == DFGUI.CHILDREN_VIEW || kind == DFGUI.LASTSEARCH_VIEW) {
                ...
                if (kind == DFGUI.PARENT_VIEW) // In this case the description that will be shown will be the description used to federate the df 
                {
