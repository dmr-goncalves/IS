...
public class DeadAgent implements Event {
     ...
     *
     * @param id The container identifier of the container where the newly dead
     * agent was deployed.
     */
     ...
     * containing the container identifier of the container where the newly dead
     * agent was deployed.
     *
     ...
     * containing the agent identifier of the newly dead agent.
     *
