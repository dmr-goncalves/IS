 ...
 * @version $Date: 2004-04-28 11:04:38 +0200 (mer, 28 apr 2004) $ $Revision:
 * 4999 $
 */
public class CreateAgent implements AgentAction {
     ...
     *
     * @param cid The container identifier of the container where the agent is
     * to be created.
     */
     ...
     *
     * @param c The initial credentials to be granted to the agent to be
     * created.
     */
    ...
    /**
     * Add an object to the <code>arguments</code> slot collection of this
     * object.
     *
    ...
    /**
     * Remove all objects from the <code>arguments</code> slot collection of
     * this object.
     */
