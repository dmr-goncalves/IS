...
/**
 * This class represents the <code>kill-container-requested</code> concept in
...
public class KillContainerRequested implements Event {
     ...
     *
     * @param id The container identifier of the container that is requested to
     * be killed.
     */
     ...
     * containing the identifier of the container that is requested to be
     * killed.
     *
