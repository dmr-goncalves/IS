 ...
 * </td>
 * <td>
 * If set to <code>true</code>, indicates that the DF will automatically clean
 * up registrations as soon as an agent terminates. The default is
 * <code>false</code>
 * </td>
 * </tr>
 * <tr>
 ...
 * </td>
 * <td>
 * Indicates the maximum lease time (in millisecond) that the DF will grant for
 * agent description registrations (defaults to infinite).
 * </td>
 * </tr>
 * <tr>
 * <td>
 ...
 * </td>
 * <td>
 * Turns off content validation on incoming/outgoing messages (defaults to
 * false)
 * </td>
 * </tr>
 * <tr>
 ...
 * </td>
 * <td>
 * If set to <code>true</code>, indicates that the DF will store its catalogue
 * into an internal HSQL database, running within the same VM. (The HSQL jar
 * files have to added to the Java CLASSPATH)
 * </td>
 * </tr>
 * <tr>
 * <td>
 ...
 * This parameter is ignored if <code>jade_domain_df_db-default</code> is set.
 * If neither this parameter nor <code>jade_domain_df_db-default</code> is
 * specified the DF will keep its catalogue in memory.
 * </td>
 * </tr>
 * <tr>
 * <td>
 ...
 * </td>
 * <td>
 * Indicates the JDBC driver to be used to access the DF database (defaults to
 * the ODBC-JDBC bridge). This parameter is ignored if
 ...
 * </td>
 * <td>
 * If set to <code>true</code>, indicates that the DF will clean the content of
 * all pre-existing database tables, used by the DF. This parameter is ignored
 * if the catalogue is not stored in a database.
 * </td>
 * </tr>
 * <tr>
 * <td>
 ...
 * </td>
 * <td>
 * If set to <code>true</code>, indicates that the DF will immediately terminate
 * in case it cannot connect to the database. This parameter is ignored if the
 * catalogue is not stored in a database.
 * </td>
 * </tr>
 * <tr>
 * <td>
 ...
 * </td>
 * <td>
 * Indicates the name of the factory class that should be used to create the
 ...
 * </td>
 * <td>
 * The dimension of the pool of thread dedicated to serving registration,
 ...
 * @version $Date: 2015-11-16 09:20:51 +0100 (lun, 16 nov 2015) $ $Revision:
 * 6775 $
 */
public class df extends GuiAgent implements DFGUIAdapter {
    ...
    /**
     * Default constructor. This constructor does nothing; however, applications
     * can create their own DF agents using regular platform management
     * commands. Moreover, customized versions of a Directory Facilitator agent
     * can be built subclassing this class and exploiting its protected
     * interface.
     */
    public df() {
    }
    ...
    /**
     * This method starts all behaviours needed by <em>DF</em> agent to perform
     * its role within <em><b>JADE</b></em> agent platform.
     */
    protected void setup() {
        ...
        agentDescriptions.setLeaseManager(new LeaseManager() {
            ...
            /**
             * Grant a lease to this request according to the policy of the DF:
             * if the requested lease is greater than the max lease policy of
             * this DF, then the granted lease is set to the max of the DF.
             *
             */
    ...
    ////////////////////////////////////
    /**
     * Add the behaviour handling a recursive search. If constraints contains a
     * null search_id, then a new one is generated and the new search_id is
     * stored into searchIdCache for later check (i.e. to avoid search loops).
     */
    ...
    /**
     * Inner class RecursiveSearchHandler. This is a behaviour handling
     * recursive searches i.e. searches that must be propagated to children
     * (federated) DFs.
     */
    private class RecursiveSearchHandler extends AchieveREInitiator {
         ...
         * found locally.
         * @param template The DFAgentDescription used as tamplate for the
         * search.
        ...
        /**
         * We broadcast the search REQUEST to all children (federated) DFs in
         * parallel.
         */
        ...
        /**
         * As long as we receive the replies we update the results. If we reach
         * the max-results we send back the notification to the requester and
         * discard successive replies.
         */
    ...
    ////////////////////////////////////////////////////////////////
    /**
     * Serve the Register action of the FIPA management ontology. Package scoped
     * since it is called by DFFipaAgentManagementBehaviour.
     */
    ...
    /**
     * Serve the Deregister action of the FIPA management ontology. Package
     * scoped since it is called by DFFipaAgentManagementBehaviour.
     */
    ...
    /**
     * Serve the Modify action of the FIPA management ontology. Package scoped
     * since it is called by DFFipaAgentManagementBehaviour.
     */
    ...
    /**
     * Serve the Search action of the FIPA management ontology. Package scoped
     * since it is called by DFFipaAgentManagementBehaviour.
     *
     * @return the List of descriptions matching the template specified in the
     * Search action. If no description is found an empty List is returned. In
     * case a recursive search is required it returns null to indicate that the
     ...
     * iterated-fipa-request protocol. Package scoped since it is called by
    ...
    //////////////////////////////////////////////////////////
    /**
     * Serve the GetParents action of the DF-Applet ontology Package scoped
    ...
    /**
     * Serve the GetDescriptionUsed action of the DF-Applet ontology Package
     * scoped since it is called by DFAppletManagementBehaviour.
     */
    ...
    /**
     * Serve the Federate action of the DF-Applet ontology Package scoped since
    ...
    /**
     * Serve the RegisterWith action of the DF-Applet ontology Package scoped
     * since it is called by DFAppletManagementBehaviour.
     */
    ...
    /**
     * Serve the ModifyOn action of the DF-Applet ontology Package scoped since
     * it is called by DFAppletManagementBehaviour.
     */
    ...
    /**
     * Serve the SearchOn action of the DF-Applet ontology Package scoped since
     * it is called by DFAppletManagementBehaviour.
     */
    ...
    /**
     * This method creates the DFAgent descriptor for this df used to federate
     * with other df.
     */
    ...
    /**
     * This method set the description of the df according to the
     * DFAgentDescription passed. The programmers can call this method to
     * provide a different initialization of the description of the df they are
     * implementing. The method is called inside the setup of the agent and set
     * the df description using a default description.
     */
     ...
     *
     * @param dfName the parent df (the df with which this df has been
     * registered)
    ...
    /**
     * Store the request message related to an action that is being processed by
     * a Behaviour. This information will be used by the Behaviour to send back
     * the notification to the requester.
     */
     ...
     * greater than maxResultLimit <li> constraints.maxResults otherwise
     * </ul>
    ...
    /**
     * Check if this search must be served, i.e. if it has not yet been
     * received. In particular the value of search_id must be different from any
     * prior value that was received. If search_id is not null and it has not
     * yet been received, search_id is added into the cache.
     *
