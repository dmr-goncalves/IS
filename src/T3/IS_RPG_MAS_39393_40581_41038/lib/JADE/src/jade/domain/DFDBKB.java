...
/**
 * This class implements a knowledge base used by the DF which stores its
 * content in an external database.
 *
...
public class DFDBKB extends DBKB {
     ...
     * Constructor
     *
     * @param maxResultLimit internal limit for the number of maximum search
     * results.
     * @param drv database driver
     * @param url database URL
     * @param user database user name
     * @param passwd database password
     * @param cleanTables specifies whether the KB should delete all existing
     * tables for the DF at startup
     * @throws SQLException an error occured while opening a connection to the
     * database
     */
    ...
    /**
     * Returns the name of the SQL type used in the database to represent very
     * long strings.
     */
    ...
    /**
     * Stores a collection of services for a specific description Id in the
     * database
     *
     * @param descrId id of the DFD these services belong to
     * @param iter iterator for a collection of <code>ServiceDescription</code>
     * instances
     * @throws SQLException
     */
    ...
    /**
     * Deletes the AID corresponding to the indicated agent name including all
     * its resolver AIDs (if there are no df descriptions left for them)
     */
    ...
    /**
     * Convert a template DFAgentDescription into the SQL SELECT operation that
     * returns the AID names whose DFAgentDescriptions match the given template.
     */
    ...
    ////////////////////////////////////////
    /**
     * Removes DF registrations and subscriptions whose lease time has expired.
    ...
    ////////////////////////////////////////////////
    /**
     * Closes an open result set and logs an appropriate error message when it
     * fails
     */
    ...
    /**
     * Closes an open SQL statement and logs an appropriate error message when
     * it fails
     */
    ...
    /**
     * This method must be used when inserting text values into a DB. It doubles
     * all ' and " characters If the passed parameter is null, then an empty
     * string is returned.
     *
     */
