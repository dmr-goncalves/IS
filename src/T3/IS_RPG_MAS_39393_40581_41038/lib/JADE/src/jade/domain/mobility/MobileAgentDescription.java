...
/**
 *
 * This class represents the <code>mobile-agent-description</code> concept.
 *
...
public class MobileAgentDescription implements Concept {
     ...
     *
     * @param d The destination of the mobility operation performed by the
     * described agent.
     */
    ...
    /**
     * Retrieve the value of the <code>destination</code> slot of this event,
     * containing the destination of the mobility operation performed by the
     * described agent.
     *
    ...
    /**
     * Retrieve the value of the <code>agent-profile</code> slot of this event,
     * containing the profile for the descrbed agent.
     *
    ...
    /**
     * Retrieve the value of the <code>agent-version</code> slot of this event,
     * containing the version string for the described agent.
     *
    ...
    /**
     * Retrieve the value of the <code>signature</code> slot of this event,
     * containing the signature string for the described agent.
     *
