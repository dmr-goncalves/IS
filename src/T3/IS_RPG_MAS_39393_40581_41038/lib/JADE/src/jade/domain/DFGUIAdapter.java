...
/**
 * This interface must be implemented by a GUI that wants to interact with the
 * DF agent. Two implementations of this interface have been realized: the class
 * jade.domain.df (used by the DF agent itself) and the class
 * jade.applet.DFAppletCommunicator (used by the DFApplet).
 *
 * @author Fabio Bellifemine - CSELT - 25/8/1999
 * @version $Date: 2003-11-18 17:26:01 +0100 (mar, 18 nov 2003) $ $Revision:
 * 4564 $
 */
public interface DFGUIAdapter {
    ...
    /**
     * This method returns the agent description of an agent registered with the
     * DF given the agent name
     */
    ...
    /**
     * This method returns the description used by the df to federate with a
     * given parent DF.
     */
