 ...
 * concepts, actions and predicates that relates to the JADE specific actions
 * that can be requested to the JADE AMS and DF.
 * <p>
 * The actual <code>Ontology</code> object representing the
 * JADE-Agent-Management-ontology is a singleton and is accessible through the
...
public class JADEManagementOntology extends Ontology implements JADEManagementVocabulary {
     ...
     * @param values - the corresponding values for the wildcards, if null no
