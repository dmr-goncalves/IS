...
public class ReceivedObject implements Concept, Serializable {
    ...
    /**
     * The constructor initializes the date to current time and all the Strings
     * to empty strings.
     *
     */
     ...
     *
     * @param b The identifier for the ACC that received the envelope containing
     * this object.
     */
    ...
    /**
     * Retrieve the <code>by</code> slot of this object. This slot identifies
     * the ACC that received the envelope containing this object.
     *
     ...
     *
     * @param f The identifier for the ACC that sent the envelope containing
     * this object.
     */
    ...
    /**
     * Retrieve the <code>from</code> slot of this object. This slot identifies
     * the ACC that sent the envelope containing this object.
     *
     ...
     *
     * @param d The date when the envelope containing this object was sent.
     */
    ...
    /**
     * Retrieve the <code>date</code> slot of this object. This slot identifies
     ...
     *
     * @param v The name of the MTP over which the envelope containing this
     * object was sent.
     */
    ...
    /**
     * Retrieve the <code>via</code> slot of this object. This slot describes
     * the MTP over which the envelope containing this object was sent.
     *
