...
/**
 * This class extends the <code>FipaRequestIntiatorBehaviour</code> in order to
 * request an agent, e.g. <em>DF or AMS</em>
 * to perform a specific action. <br>
 * This class implements all the abstract method of the super classes, therefore
 * the behaviour can be immediately added to an agent.  <br>
 * In some cases, it might be usefull to extend this class to override some of
 * its methods and react to the received messages in an application-specific
 * manner. <br>
 * The class has two constructor. The first generic constructor can be used for
 * all the action an agent can perform. In the case of a a search action the
 * default search constraints are used. <br>
 * The second constructor is specific for a search action and it allows to
 * specify additional search constraints.
 *
...
public class RequestFIPAServiceBehaviour extends SimpleAchieveREInitiator {
    ...
    /**
     * Exception class for timeouts. This exception is thrown when trying to
     * obtain an <code>ACLMessage</code> from an <code>Handle</code> and no
     * message has been yet received and the timeout limit is not yet elapsed.
     *
     ...
     * @param agentDescription An agent descriptor used according to the action
     * required.
     * @param constraints The search contraints for the search action.
     * @exception FIPAException A suitable exception can be thrown when the
     * method locally discovers that the passed parameters are not valid.
    ...
    /**
     * Create a behaviour to request an agent to perform a specific action. The
     * default search constraints are used.
     *
     * @param a The agent this behaviour belongs to, i.e the agent who is
     * interested in the action.
     * @param dfName The DF who will perform the action.
     * @param dfAction The action requested to the DF.
     * @param dfd An agent descriptor that will be use according to the action
     * required to the DF.
     * @see #RequestFIPAServiceBehaviour(Agent a, AID receiver, String
     * actionName, Object agentDescription, SearchConstraints constraints)
     */
     ...
     * <code>not-understood</code> type and matches the conversation template.
     */
     ...
     *
     * @param reply The actual ACL message received. It is of
     * <code>refuse</code> type and matches the conversation template.
     */
     ...
     *
     * @param reply The actual ACL message received. It is of <code>agree</code>
     * type and matches the conversation template.
     */
     ...
     *
     * @param reply The actual ACL message received. It is of
     * <code>failure</code> type and matches the conversation template.
     */
     ...
     *
     * @param reply The actual ACL message received. It is of
     * <code>inform</code> type and matches the conversation template.
     */
    ...
    /**
     * This method handle is called after receiving all the responses and when
     * the timeout is expired( in this case no reply has been received.
     */
     ...
     * @exception FIPAException A suitable exception can be thrown when the
     * protocol was finished with a FAILURE/REFUSE or NOT-UNDERSTOOD
     * performative.
     ...
     * This public method allows to get the results of a search operation.
     *
     * @return An array of Objects containing the items found as the result of
     * the search.
     * @exception FIPAException A suitable exception can be thrown when the
     * protocol was finished with a FAILURE/REFUSE or NOT-UNDERSTOOD
     * performative.
