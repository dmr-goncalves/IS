...
/**
 * This class represents the JADE-Persistence ontology i.e. the set of concepts,
 * actions and predicates that relates to the JADE Persistence Service features
 * that can be accessed through the JADE AMS.
 * <p>
 * The actual <code>Ontology</code> object representing the JADE-Persistence
 * ontology is a singleton and is accessible through the static method
