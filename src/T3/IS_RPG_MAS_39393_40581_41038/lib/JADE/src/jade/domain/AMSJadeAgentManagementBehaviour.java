...
/**
 * This behaviour serves the actions of the JADE management ontology supported
 ...
 * returned (RESULT or DONE) - whether the notification can be sent immediately
 * or must be delayed at a later time.
 *
 * @author Tiziana Trucco - Tilab
 * @author Giovanni Caire - Tilab
 * @version $Date: 2008-08-19 12:27:27 +0200 (mar, 19 ago 2008) $ $Revision:
 * 6043 $
 */
