...
public class MobileAgentOS implements Concept {
     ...
     *
     * @param v The major version number of the OS of the described agent.
     */
     ...
     * containing the major version number of the OS of the described agent.
     *
     ...
     * containing the minor version number of the OS of the described agent.
     *
     ...
     * containing the OS dependencies of the described agent.
     *
