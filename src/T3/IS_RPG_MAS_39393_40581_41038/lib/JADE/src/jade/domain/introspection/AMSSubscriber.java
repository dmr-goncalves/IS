...
/**
 * This behaviour subscribes to the AMS to receive notifications about
 * platform-wide events. The <code>installHandlers</code> method must be
 * redefined to define the handlers for events the agent executing this
 * behaviour is interested in.
 *
...
public abstract class AMSSubscriber extends SimpleBehaviour {
    ...
    /*#DOTNET_INCLUDE_BEGIN
	 ...
	 #DOTNET_INCLUDE_END*/
    /**
     * This interface must be implemented by concrete event handlers installed
     * by this AMSSubscriber.
     */
    ...
    /**
     * Construct an AMSSubscriber behaviour to receive notifications about
     * platform events from the local AMS
     */
    ...
    /**
     * Construct an AMSSubscriber behaviour to receive notifications about
     * platform events from the AMS of a remote platform.
     *
     ...
     * <code>Map</code> passed as parameter with implementations of the
     * <code>EventHandler</code> interface, using the name of the event as key
     * (see the <code>Event</code> interface.
     *
     * @param handlersTable The table that associates each event name with a
     * proper handler.
     */
    ...
    /**
     * Retrieve the <code>subscribe</code> ACL message used to subscribe to the
     * AMS. This message is automatically sent when this behaviour is added to
     * an Agent.
     *
    ...
    /**
     * Retrieve the <code>cancel</code> ACL message used to cancel the
     * subscription to the AMS. Since this behaviour is cyclic (never ends) it
     * is the responsibility of the agent executing this behaviour to send the
     * <code>cancel</code> message to the AMS when notifications are no longer
     * required.
     *
