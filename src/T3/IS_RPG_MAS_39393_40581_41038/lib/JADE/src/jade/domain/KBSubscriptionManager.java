...
class KBSubscriptionManager implements SubscriptionResponder.SubscriptionManager {
     ...
     * subscribed agents if necessary. NOTE that if a df poolsize > 0 is
     * specified this method is executed in a different Thread --> This is the
     * reason for the synchronized blocks
     */
    ...
    /**
     * Inner class SubscriptionInfo This class associates a Subscription object
     * with the DFAgentDescription that acts as template for that Subscription
     * object
     */
