...
/**
 * This class represents the BehaviourLoading ontology including the concepts
 * and actions required to dynamically load and execute jade behaviours whose
 * code is not included in the JVM classpath.
 *
...
public class BehaviourLoadingOntology extends Ontology implements BehaviourLoadingVocabulary {
    ...
    /**
     * This method returns the singleton instance of the Behaviour-Loading
     * ontology.
     *
