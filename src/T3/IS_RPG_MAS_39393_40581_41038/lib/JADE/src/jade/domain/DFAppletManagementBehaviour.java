...
/**
 * This behaviour serves the actions of the DF_Applet ontology supported by the
 * DF. It extends RequestManagementBehaviour and implements performAction() to
 * i) call the method of the DF corresponding to the requested action and ii)
 * prepare the result notification.
 *
...
class DFAppletManagementBehaviour extends RequestManagementBehaviour {
    ...
    *
     ...
     *
     * switch (actionID){ case GETPARENT: reply =
     * myAgent.getParentAction(SLAction,request); break; case
     * GETDEFAULTDESCRIPTION: reply =
     * myAgent.getDescriptionOfThisDFAction(SLAction,request); break; case
     * FEDERATEWITH : myAgent.federateWithAction(SLAction,request); break; case
     * GETDESCRIPTIONUSED : reply =
     * myAgent.getDescriptionUsedAction(SLAction,request); break; case
     * DEREGISTERFROM : myAgent.deregisterFromAction(SLAction,request); break;
     * case REGISTERWITH: myAgent.registerWithAction(SLAction,request); break;
     * case SEARCHON: myAgent.searchOnAction(SLAction,request); break; case
     * MODIFYON: myAgent.modifyOnAction(SLAction,request); break; default:
     * break; //FIXME: should never occur }
     *
     * return reply; }
     *
     * //to reset the action public void reset(){ super.reset(); action = null;
     * actionID = UNSUPPORTED; SLAction = null; }
     */
}
