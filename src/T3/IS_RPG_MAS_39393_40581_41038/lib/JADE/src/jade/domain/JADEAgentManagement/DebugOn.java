...
public class DebugOn implements AgentAction {
     ...
     *
     * @return The value of the <code>debugger</code> slot, or <code>null</code>
     * if no value was set.
     */
    ...
    /**
     * Add an agent identifier to the <code>debugged-agents</code> slot
     * collection of this object.
     *
     ...
     * containing the password used to authenticate the principal requesting
     * this action.
     *
