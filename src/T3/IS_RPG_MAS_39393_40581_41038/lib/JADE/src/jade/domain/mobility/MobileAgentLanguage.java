...
/**
 *
 * This class represents the <code>mobile-agent-language</code> concept.
 *
...
public class MobileAgentLanguage implements Concept {
     ...
     *
     * @param v The major version number of the language of the described agent.
     */
     ...
     * containing the major version number of the language of the described
     * agent.
     *
     ...
     * containing the minor version number of the language of the described
     * agent.
     *
     ...
     * containing the language dependencies of the described agent.
     *
