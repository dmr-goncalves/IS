...
public class DFAgentDescription implements Concept {
     ...
     * DFAgentDescription as an absolute time. Use <code>null</code> (default)
     * to indicate an infinite lease time
     */
    ...
    /**
     * Retrieve the lease time for the registration of this description (i.e.,
     * how long it will be kept within the DF agent knowledge base).
     *
     * @return The lease time for the registration of this
     * <code>DFAgentDescription</code> as an absolute time. A <code>null</code>
     * value indicates an infinite time.
     */
    ...
    /**
     * Add a service description to the <code>service</code> slot collection of
     * this object.
     *
    ...
    /**
     * Remove a service description from the <code>services</code> slot
    ...
    /**
     * Remove all protocol names from the <code>protocols</code> slot collection
     * of this object.
     */
    ...
    /**
     * Access all protocol names from the <code>protocols</code> slot collection
     * of this object.
     *
    ...
    /**
     * Add an ontology name to the <code>ontologies</code> slot collection of
     * this object.
     *
    ...
    /**
     * Remove an ontology name from the <code>ontologies</code> slot collection
     * of this object.
     *
    ...
    /**
     * Add a content language name to the <code>languages</code> slot collection
     * of this object.
     *
