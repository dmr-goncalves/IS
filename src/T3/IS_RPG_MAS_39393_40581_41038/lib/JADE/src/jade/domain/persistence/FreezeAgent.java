 ...
 * <code>JADE-Persistence</code> ontology. This action can be requested to the
 * JADE AMS to freeze an agent so that its state is moved to a persistent
 * storage, but the agent appears as alive and its messages are buffered by the
 * platform.
 *
