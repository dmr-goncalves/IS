...
/**
 * This class provides an abstract implementation of the <code>KB</code>
 * interface where information are stored in a database.
 *
...
public abstract class DBKB extends KB {
    ...
    /**
     * This ThreadLocal is used to hold connections and associated additional
     * information (such as prepared statements) currently used by each Thread
     */
    ...
    /**
     * Specifies whether the KB should delete all existing tables for the DF at
     * startup
     */
    ...
    /**
     * Constructs a new <code>DFKB</code> and establishes a connection to the
     * database at the given URL using the
     * <code>sun.jdbc.odbc.JdbcOdbcDriver</code> driver.
     *
     * @param maxResultLimit internal limit for the number of maximum search
     * results.
     * @param url database URL
     * @param maxResultLimit JADE internal limit for the maximum number of
     * search results
    ...
    /**
     * This method is called by the KB Factory and is a placeholder for
     * implementation specific KB initializations.
     */
    ...
    /**
     * Subclasses can redefine this method to provide implementation specific
     * ConnectionWrapper initializations
     */
