...
public class AddedBehaviour implements Event {
     ...
     *
     * @param id The agent identifier of the agent the behaviour was added to.
     */
     ...
     * containing the agent identifier of the agent the behaviour was added to.
     *
     ...
     *
     * @param id The behaviour identifier of the newly added behaviour.
     */
     ...
     * containing the behaviour identifier of the newly added behaviour.
     *
