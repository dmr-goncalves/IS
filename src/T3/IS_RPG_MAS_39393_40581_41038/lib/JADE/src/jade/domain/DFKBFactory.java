...
/**
 * The <code>DFKBFactory</code> class creates knowledge base objects used by the
 * DF.
 *
 * <p>
 * To run JADE with your own knowledge base implementation a new sub class of
 * <code>DFKBFactory</code>, overriding the appropriate method(s), has to be
 * implemented and specified by the command line parameter
...
public class DFKBFactory {
     ...
     *
     * @param maxResultLimit internal limit for the maximum number of search
     * results
     */
