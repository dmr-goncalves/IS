 ...
 * @version $Date: 2009-08-26 08:56:09 +0200 (mer, 26 ago 2009) $ $Revision:
 * 6183 $
 */
public class Envelope implements Concept, jade.util.leap.Serializable {
    ...
    /**
     * Remove an agent identifier from the <code>to</code> slot collection of
     * this object.
     *
     * @param id The agent identifierto remove from the collection.
     * @return A boolean, telling whether the element was present in the
     * collection or not.
     */
    ...
    /**
     * Remove all agent identifiers from the <code>to</code> slot collection of
     * this object.
     */
    ...
    /**
     * Access all agent identifiers from the <code>to</code> slot collection of
     * this object.
     *
     ...
     *
     * @return The value of the <code>payload-length</code> slot of this
     * envelope, or <code>null</code> or a negative value if no value was set.
     */
    ...
    /**
     * Set the <code>payload-encoding</code> slot of this object. This slot can
     * be used to specify a different charset than the standard one (US-ASCII)
     * in order for instance to support accentuated characters in the content
     * slot of the ACL message (e.g. setPayloadEncoding("UTF-8")).
     *
     ...
     *
     * @return The value of the <code>payload-encoding</code> slot of this
     * envelope, or <code>null</code> if no value was set.
     */
    ...
    /**
     * Add an agent identifier to the <code>intended-receiver</code> slot
     ...
     * method is used by the ACC to add a new stamp to the envelope at every
     * routing hop.
     *
    ...
    /**
     * Access the list of all the stamps. The <code>received-object</code>
     * stamps are sorted according to the routing path, from the oldest to the
     * newest.
     */
    ...
    /**
     * Add a property to the <code>properties</code> slot collection of this
     * object.
     *
    ...
    /**
     * Remove a property from the <code>properties</code> slot collection of
     * this object.
     *
