 ...
 * @version $Date: 2005-08-24 17:21:34 +0200 (mer, 24 ago 2005) $ $Revision:
 * 5758 $
 */
public class AddedContainer implements Event {
     ...
     *
     * @param id The container identifier of the newly added container.
     */
     ...
     * containing the container identifier of the newly added container.
     *
     ...
     *
     * @param o The name of the entity owning the newly added container.
     */
    ...
    /**
     * Retrieve the value of the <code>ownership</code> slot of this event,
     * containing the name of the entity owning the newly added container.
     *
