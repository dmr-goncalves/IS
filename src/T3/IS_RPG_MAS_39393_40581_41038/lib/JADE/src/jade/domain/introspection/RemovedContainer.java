...
/**
 *
 * An introspection event, recording the removal of an agent container within
 * the platform.
 *
...
public class RemovedContainer implements Event {
     ...
     *
     * @param id The container identifier of the newly removed container.
     */
     ...
     * containing the container identifier of the newly removed container.
     *
