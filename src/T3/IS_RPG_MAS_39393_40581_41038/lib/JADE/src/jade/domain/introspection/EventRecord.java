...
public class EventRecord implements Concept {
    ...
    /**
     * Construct an event record, attaching a location and a timestamp to an
     * event object.
     *
     ...
     * containing the occurred event.
     *
     * @return The value of the <code>what</code> slot, or <code>null</code> if
     * no value was set.
     */
     ...
     *
     * @return The value of the <code>when</code> slot, or <code>null</code> if
     * no value was set.
     */
    public Date getWhen() {
        return when;
     ...
     * containing the location where the event occurred.
     *
