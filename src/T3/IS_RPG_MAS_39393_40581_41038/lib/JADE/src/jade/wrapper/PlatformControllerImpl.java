...
class PlatformControllerImpl implements PlatformController {
     ...
     * This in fact would cause a deadlock condition. If an agent needs to
     * invoke it it should spawn a dedicated Thread.
     *
     * @throws ControllerException If any probelms other than illegal state
     * occur.
     * @throws IllegalStateException If state is illegal for this activity.
    ...
    /**
     * Inner class ListenerWrapper This utility class wraps a
     * jade.wrapper.PlatformController.Listener into a
