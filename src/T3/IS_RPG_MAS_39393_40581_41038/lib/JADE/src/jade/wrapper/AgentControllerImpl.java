...
/**
 * This class is a Proxy class, allowing access to a JADE agent. Invoking
 * methods on instances of this class, it is possible to trigger state
 * transition of the agent life cycle. This class must not be instantiated by
 * applications. Instead, use the <code>createAgent()</code> method in class
...
class AgentControllerImpl implements AgentController {
    ...
    /**
     * This constructor should not be called by applications. The method
     * <code>AgentContainer.createAgent()</code> should be used instead.
     */
    ...
    /**
     * @see jade.wrapper.AgentController#clone(jade.core.Location,
     * java.lang.String)
     */
