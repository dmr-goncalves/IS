...
public abstract class StateBase implements State, Comparable, Serializable {
    ...
    /**
     * An array of string names, one for each of the valid state this object can
     * represent.
     */
    ...
    /**
     * Creates a state object for a given code. To avoid coding errors, the
     * integer codes used to create instances of this class should come from the
     * concrete extensions of this class.
     * <p>
     ...
     * @param aBaseCode Value corresponding to first entry in names. Typically 0
     * or 1.
    ...
    /**
     * Converts a descriptive state name into a state code. The name comparison
     * is not case sensitive. If the name cannot be located for any reason a
     * {@link java.lang.IllegalArgumentException IllegalArgumentException} will
     * be thrown
     *
     * @param name The descriptive name of a state to convert to a state code.
     * @return The integer state code corresponding to the provided state name.
     */
     ...
     * @return The descriptive name of the state or null if the state code is
     * "out of range" (i.e. invalid).
     */
    ...
    /**
     * Determines if an object is equal to this object. In order for the the
     * passed object to be equal to this one the passed object must be an
     * instance if State and contain the same state code.
     *
     ...
     * collating. This method is used for the sorting of states. A positive
     * value means the receiver (this object) is "greater than" the passed
     * object. A negative value means the receiver is "less than" the passed
     * object. A value of zero means the receiver and the passed object are
     * equal to each other.
     *
     ...
     * null objects)</li>
     * <li> the state code held by the receiver (this object) is greater than
     ...
     * The value -1 is returned if:
     * <ul>
     * <li> the passed object is not a AgentStateImpl object (the receiver is
     * considered "less than" objects of other types)</li>
     * <li> the state code held by the receiver (this object) is less than the
     * code of the passed object</li>
     * <ul>
     */
    ...
    /**
     * Returns the hash code for this state. The hash code equals the state
     * code.
     *
    ...
    /**
     * A string representation of this state. The returned string is of the form
     * StateName(StateCode).
     *
    ...
    /**
     * Return a string containing all descriptions and their codes. Usefull for
     * debugging.
     *
