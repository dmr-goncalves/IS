...
public interface PlatformController {
    ...
    public static interface Listener extends EventListener {
        ...
        /**
         * Called when the platform is started. PlatformEvent source is
         * PlatformController.
         */
        public void startedPlatform(PlatformEvent anEvent);

        /**
         * Called when the platform is suspended. PlatformEvent source is
         * PlatformController.
         */
        public void suspendedPlatform(PlatformEvent anEvent);

        /**
         * Called when the platform is activated. PlatformEvent source is
         * PlatformController.
         */
        public void resumedPlatform(PlatformEvent anEvent);

        /**
         * Called when the platform is killed (destroyed). PlatformEvent source
         * is PlatformController.
         */
     ...
     *
     * @throws ControllerException If any probelms other than illegal state
     * occur.
     ...
     * @param args The agents parameters - typically String[] from a
     * configuration file.
     * @return AgentController to enable control of the agent.
     * @throws IllegalStateException If state is illegal for this activity.
     * @throws ControllerException If any else goes wrong. All other exceptions
     * are caught and rethrown as a ControllerException.
     */
