 ...
 *
 * @version $Date: 2010-04-08 15:54:18 +0200 (gio, 08 apr 2010) $ $Revision:
 * 6298 $
 *
 */
public class BootHelper {
     ...
     * String is a token of type agentName: or className( or argument This
     * method is declared public because it is currently used by
     * <code>jade.tools.rma.StartNewAgentAction</code>
     *
     * @param s1 The source string.
     * @param keepquote when true no char is removed, apart from blanks between
     * tokens. when false, quote chars are removed and also escaped quotes
     * become just quotes.
     *
     ...
     * <code>Specifier</code> This method is declared public because it is
     * currently used by <code>jade.tools.rma.StartNewAgentAction</code>
     *
     ...
     * @return true if this was the last argument, i.e. it found a closed
     * bracket
     */
