...
public class BootProfileImpl extends ProfileImpl {
 ...
 /*
     ...
     * @return True or false depending on the attributes setting. False if
     * attribute doesn't exist.
     * @throws PropertiesException if there is a value but its not either "true"
     * or "false".
     */
     ...
     * <p>
     * For instance <code>jade.mtp.iiop(50);http.mtp.http(8080)</code> is a
     * valid string, while  <code>jade.mtp.iiop(50 80);http.mtp.http(8080)</code>
     * is not valid For each object specifier, a new java object
     * <code>Specifier</code> is added to the passed <code>out</code> List
     * parameter.
     */
