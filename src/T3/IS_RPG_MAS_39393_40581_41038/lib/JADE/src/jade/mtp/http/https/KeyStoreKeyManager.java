...
/**
 * HTTPSKeyManager that extracts its trust material from a given KeyStore. This
 * key manager needs some configuration parameters:
 *
 * <b>jade_mtp_http_https_keyStoreType</b>: The type of KeyStore to use
 * (defaults to JKS)
 *
 * <b>jade_mtp_http_https_keyStoreFile</b>: The File Containing the KeyStore.
 * This keystore can only contain a key entry (Private Key + X509 Certificate).
 * The password encrypting this key must be the same password of the KeyStore.
 * This key material will be used to authenticate local platform when remote
