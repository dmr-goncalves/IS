...
public class HTTPIO {
   ...
   * ***********************************************/
    /**
     * Blocks on read until something is available on the stream or the stream
     * is closed
     */
    /*
    ...
    /**
     * Reads byte sequence from specified input stream into specified output
     * stream up to specified byte sequence pattern is occurred. The output byte
     * sequence does not contains any bytes matched with pattern. If the
     * specified pattern was not found until the input stream reaches at end,
     * output all byte sequence up to end of input stream and returns false.
     *
    ...
    /**
     * Read a line of text from specified input stream. A line is considered to
     * be terminated by a carriage return ('\r') followed immediately by a
     * linefeed ('\n').
     *
    ...
    /**
     * Write characters contained specified string to specified output
     * stream.<br />
     * These characters must be 7-bit character, and stored only low-byte of
     * each code.
     *
     * @param output specified output stream.
