 ...
 * in authentication. No checks are performed over certificates sent during the
 * protocol handshaking. Several attacks can be performed if we use this trust
 * manager, be very careful in using it.
 *
