...
/**
 * This class implements a concrete behaviour for HTTPS Trust decisions. If we
 * configure the platform to use this TrustManager, we must also specify two
 * configuration properties:
 *
 * <b>jade_mtp_http_https_firendListFile</b>: This property must indicate the
 * location of a java KeyStore in the disc.
 *
 ...
 * connection is stablished, trust decisions will be made in terms of the
 * certificates inside the KeyStore. If the Certificate sent by the remote peer
 * is inside of the KeyStore or signed by one of the issuers of the inside the
 * KeyStore, the connection will be stablished. Otherwise the connection will
 * not be possible.
 *
