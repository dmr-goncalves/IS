 ...
 * </code> Notice that, in the third case, BIG_ENDIAN is assumed by default. In
 * the first and second case, instead, the endianess information is contained
 * within the IOR definition.
 *
 */
