...
public class MessageTransportProtocol implements MTP {
     ...
     * Default value is 10. Set to 0 to disable keep-alive coonections (possible
     * performance impact).</LI>
     * <LI><B>proxyHost</B>: Proxy host name or IP-address. No default
     * value.</LI>
     ...
     * <LI><B>parser</B>: XML SAX2 parser implementation to use. Default value
     * is JDK 1.4 default parser.</LI>
     * <LI><B>policy</B>: "conservative" (default value) or "aggressive". (see
     * documentation for details).</LI>
     * <LI><B>timeout</B>: Timeout for keep-alive connections. Default value is
     * 1 min. 0 means infinite.</LI>
     * </UL>
