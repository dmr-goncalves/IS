...
public class LEAPIMTPManager implements IMTPManager {
    ...
    // /////////////////////////
    /**
     * In the Profile ICPS can be specified as follows. 1) If there is only one
     * ICP --> icps = <icp-class-name>
     * <param-key> = <param-value>
     * ....... 2) In general (typically used when there are 2 or more ICPs) icps
     ...
     * / J2SE or PJAVA - There is at least 1 ICP already active --> Nothing -
     * There are no ICPs already active --> JICPPeer b) Peripheral container /
     * MIDP --> Throws a ProfileException c) Main container / J2SE or PJAVA -->
     * JICPPeer
     */
