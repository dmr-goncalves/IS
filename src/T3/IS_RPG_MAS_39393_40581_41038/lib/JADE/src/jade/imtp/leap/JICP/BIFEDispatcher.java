...
public class BIFEDispatcher implements FEConnectionManager, Dispatcher, TimerListener, Runnable {
    ...
    /**
     * Inner class InputManager. This class is responsible for serving incoming
     * commands
     */
    ...
    /**
     * Close the current outConnection (if any) and starts a new thread that
     * asynchronously tries to restore it.
     */
    ...
    ////////////////////////////////////////////////////////////////
    /**
     * Refresh the keep-alive timer. Mutual exclusion with doTimeOut()
     */
    ...
    /**
     * Refresh the connection drop-down timer. Mutual exclusion with doTimeOut()
     */
    ...
    /**
     * Send a KEEP_ALIVE packet to the BE. This is executed within a
     * synchronized block --> Mutual exclusion with dispatch() is guaranteed.
     */
    ...
    /**
     * Send a DROP_DOWN packet to the BE. The latter will also close the INP
     * connection. This is executed within a synchronized block --> Mutual
     * exclusion with dispatch() is guaranteed.
     */
