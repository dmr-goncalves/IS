...
/**
 * BackEnd side dispatcher class that extends <code>NIOBEDispatcher</code> and
 * uses SMS to perform OUT-of-bound notifications to the FrontEnd when the
 * connection (currently dropped) must be re-established.
 *
 * @see SMSFEDispatcher
