...
public class RMIIMTPManager implements IMTPManager {
    ...
    /**
     * This constant is the name of the property whose value contains the TCP
     * port where a local Service Manager is to be exported (when using JADE
    ...
    /**
     * This constant is the name of the property whose value contains the TCP
     * port where the local RMI Node is to be exported.
     */
    public static final String LOCAL_NODE_PORT = "nodeport";

    /**
     * This constant is the name of the property whose boolean value indicates
     * whether or not RMI logs have to be enabled (default false)
     */
    ...
    /**
     * Inner class PlatformManagerAdapter. An adapter, implementing the
     * PlatformManager interface, to a ServiceManagerRMI stub
     */
