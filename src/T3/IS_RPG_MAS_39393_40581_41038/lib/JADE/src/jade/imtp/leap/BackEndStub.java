...
public class BackEndStub extends MicroStub implements BackEnd {
    ...
    /**
     * The method encodes the create mediator request, setting all the common
     * properties retrived in the passed property parameter.
     *
     * @param pp
     * @return a StringBuffer to allow the dispatcher to add dispatcher specific
     * properties.
     */
