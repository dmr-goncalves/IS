...
public class NIOHelper {
    ...
    /**
     * copy data from src to dst, as much as fits in dst. src's position() will
     * be moved when data are copied.
     *
     * @param src copy from
     * @param dst copy to
    ...
    /**
     * calls {@link NIOHelper#enlargeBuffer(java.nio.ByteBuffer, int, java.lang.String, boolean)
     * } with false for doLog
     *
     * @param b
     * @param extraSpace
