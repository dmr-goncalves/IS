...
public interface ICP {
    ...
    public static interface Listener {
        ...
        /**
         * Handle a received (still serialized) command object, i.e. deserialize
         * it and launch processing of the command.
         *
         * @param serialized_command the command to be deserialized and
         * processed
