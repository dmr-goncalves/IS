...
public class HTTPFEDispatcher implements FEConnectionManager, Dispatcher, TimerListener {
    ...
    ////////////////////////////////////////////////
    /**
     * Create a BackEnd in the fixed network and return a stub to communicate
     * with it
     */
    ...
    /**
     * Make this HTTPFEDispatcher terminate. Note that when the BackEnd receives
     * the termination notification (explicitly sent in case of a self-initiated
     * shutdown or attached to the response to the EXIT command), it closes the
     * input connection. The InputManager gets an exception and, since it has
     * been killed, terminates.
     */
     ...
     * create the BackEnd in the fixed network. Executed - at bootstrap time by
     * the thread that creates the FrontEndContainer. - To re-attach to the
     * platform after a fault of the BackEnd
     */
    ...
    //////////////////////////////////////////////
    /**
     * Dispatch a serialized command to the BackEnd and get back a serialized
     * response. Mutual exclusion with itself to preserve dispatching order
     */
    ...
    /**
     * Inner class InputManager This class deals with incoming commands
     * (possibly keep-alive packets)
     */
    ...
    /**
     * Deliver a packet to the BackEnd and get back a response using a fresh
     * one-shot connection
     */
    ...
    /**
     * Inner class DisconnectionManager. Manages issues related to disconnection
     * of the device.
     */
    class DisconnectionManager implements Runnable {
         ...
         * thread that periodically ping the back-end to detect when we are
         * reachable again
         */
        ...
        /**
         * Set the reachability state as "reachable" and notify the InputManager
         * thread in case it is waiting in waitUntilReachable().
         */
        ...
        /**
         * Wait until the device is reachable again. This is executed by the
         * InputManager thread before sending a response
         */
         ...
         * BackEnd to detect when the device is reachable again. When the
         * BackEnd receives a CONNECT_MEDIATOR packet it resets the input
         * connection --> If blocked waiting for incoming commands, the
         * InputManager thread should get an IOException.
         */
        public void run() {
            int attemptCnt = 0;
    ...
    /**
     * Inner class KeepAliveManager This class is responsible for taking track
     * of keep-alive packets and detect problems when they miss.
     */
