...
/**
 * This class implements a data output stream serializing Deliverables,
 * primitive types and J2SE class types that are considered as primitive type to
 * a given byte array according to the LEAP surrogate serialization mechanism.
 *
...
class DeliverableDataOutputStream extends DataOutputStream {
     ...
     *
     * @return the byte array containing the serialized Deliverables written to
    ...
    /**
     * Writes an object whose class is not known from the context to this data
     * output stream.
     *
    ...
    public void writeObject(Object o) throws LEAPSerializationException {
        try {
            if (o != null) {
		        ...
		        #MIDP_INCLUDE_END*/ //#MIDP_EXCLUDE_BEGIN
    ...
    /**
     * Note that when delivering messages to agents we never deal with
     * ACLMessage objects since they are ALWAYS encoded/decoded by the Messaging
     * filters. However there may be services that use ACLMessage objects as
     * parameters in their HCommands
     */
