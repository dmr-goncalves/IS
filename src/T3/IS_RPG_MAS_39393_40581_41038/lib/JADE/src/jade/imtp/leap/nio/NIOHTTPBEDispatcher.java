...
public class NIOHTTPBEDispatcher implements NIOMediator, Dispatcher, BEConnectionManager {
    ...
    /**
     * Termination self initiated or forced by the MediatorManager we are
     * attached to.
     */
    public void kill() {
        status = NOT_ACTIVE;
     ...
     * a CREATE or CONNECT_MEDIATOR request is received. In both cases the
     * Front-end is connecting --> Set the front-end status to CONNECTING, but
     * don't use this connection: to allow us sending commands to the front-end
     * an initial dummy response will be received soon.
     */
