...
/**
 * helper class that holds the ByteBuffers, SSLEngine and other Objects that
 * deal with the non static part of the ssl/nio handshaking/input/output. The
 * contained SSLEngine is hidden to apps, because this helper takes on the
 * responsibility of dealing with concurrency issues
 *
 * @author eduard
 */
public final class SSLEngineHelper implements BufferTransformer {
    ...
    /**
     * generates handshake data and calls {@link NIOJICPConnection#writeToChannel(java.nio.ByteBuffer)
     * }, possibly recursive when required by handshaking
     *
