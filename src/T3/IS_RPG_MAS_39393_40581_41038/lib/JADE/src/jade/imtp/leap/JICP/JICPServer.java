...
public class JICPServer extends Thread
        //#J2ME_EXCLUDE_BEGIN
        implements PDPContextManager.Listener, JICPMediatorManager //#J2ME_EXCLUDE_END
{
    ...
    /**
     * JICPServer thread entry point. Accept incoming connections and for each
     * of them start a ConnectionHandler that handles it.
     */
    public void run() {
        int chCount = 0;
