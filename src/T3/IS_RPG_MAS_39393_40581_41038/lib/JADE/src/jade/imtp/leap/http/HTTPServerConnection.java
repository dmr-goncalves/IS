...
/**
 * Connection class to handle HTTP requests/responses on the server side. Note
 * that unlike the HTTPClientConnection that "looks like" a permanent pipe where
 * several request/response sessions can occur, the HTTPServerConnection handles
