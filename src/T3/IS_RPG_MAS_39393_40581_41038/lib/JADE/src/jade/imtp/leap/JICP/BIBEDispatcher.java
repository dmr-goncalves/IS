...
public class BIBEDispatcher extends Thread implements BEConnectionManager, Dispatcher, JICPMediator {
    ...
    /**
     * Shutdown self initiated or forced by the JICPServer this BackEndContainer
     * is attached to.
     */
    public void kill() {
    ...
    /**
     * Inner class InpConnectionHolder. Wrapper for the connection used to
     * deliver commands to the FrontEnd
     */
    ...
    /**
     * Inner class OutConnectionHolder Wrapper for the connection used to
