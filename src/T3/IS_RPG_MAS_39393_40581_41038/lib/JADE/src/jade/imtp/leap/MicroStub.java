...
public class MicroStub {
    ...
    /**
     * Note that normal command-dispatching and postponed command flushing can't
     * occur at the same time, but different commands can be dispatched in
     * parallel. This is the reason for this lock/unlock mechanism instead of a
