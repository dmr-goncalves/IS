...
public interface JICPMediator {
     ...
     * This is called by the JICPServer this Mediator is attached to as soon as
     * the mediated entity (re)connects.
     *
    ...
    /**
     * Passes to this JICPMediator a JICP packet. This is called by the
     * JICPServer this Mediator is attached to when a JICPPacket is received
     * having the recipient-ID field set to the ID of this JICPMediator.
     *
    ...
    /**
     * This is periodically called by the JICPMediatorManager and should be used
     * by a JICPMediator to evaluate the elapsed time without the need of a
