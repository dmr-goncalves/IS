...
public class BackEndDispatcher implements NIOMediator, BEConnectionManager, Dispatcher {
     ...
     * it is using. This information is important since, unlike normal
    ...
    /**
     * Request the FE to refresh the connection. This default implementation
     * does nothing. Subclasses may redefine this method to exploit some
     ...
     * and keep-alive packets from the FrontEnd.
     */
