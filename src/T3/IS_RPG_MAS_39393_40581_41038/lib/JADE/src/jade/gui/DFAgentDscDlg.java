...
public class DFAgentDscDlg extends JDialog implements ActionListener {
  ...
  #DOTNET_INCLUDE_END*/
     ...
     * @param ed true if the fields of the gui must be editable, false
     * otherwise.
     * @param checkMandatorySlots true to verify that a value is specified for
     * all the mandatory fields, false otherwise.
     * @return a DFAgentDescription if the OK button is pressed, false if the
        ...
        bOK.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (param.equals("OK")) { // the user pressed the OK button
                    if (editable) { // if it is editable then I have to collect all data in the GUI and create a DFAgentDescription to return to the caller
