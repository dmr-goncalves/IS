 ...
 * methods can be used to enable/disable modifications to all fields in the ACL
 * message and/or the sender field respectively.<br>
 * E.g.<br>
 * This code creates an agent GUI with a panel (in the left part of the GUI)
 * that displays each new message received by the agent
 * <code>
 * .....<br>
 * AclGui acl;<br>
 * .
 ...
 * <em>editMsgInDialog()</em> and <em>showMsgInDlg()</em>
 * static methods that pop up a temporary dialog window (including an AclGui
 * panel and the proper OK and Cancel buttons) by means of which it is possible
 * to edit and show a given ACL message.<br>
 * E.g.<br>
 * This code creates a button that allows the user to edit an ACL message by
 * means of a temporary dialog window
 * <code>
 * .....<br>
 * ACLMessage msg;<br>
 * .
 ...
 * @version $Date: 2010-07-14 18:59:27 +0200 (mer, 14 lug 2010) $ $Revision:
 * 6360 $
...
public class AclGui extends JPanel {
    ...
    private class AclMessagePanel extends JPanel
            ...
            implements DropTargetListener //#DOTNET_EXCLUDE_END
    {
    ...
    public void setMsg(ACLMessage msg) {
        ...
        if ((lang.equalsIgnoreCase(FIPANames.ContentLanguage.FIPA_SL0)
                ...
                && (slFormatter != null)) // Try inserting formatted SL content.
        {
    ...
    /*public void setBorder(Border b)
  {
     ...
     * displays the specified ACL message in it. The dialog window also includes
     * an OK and a Cancel button to accept or discard the performed editing.
     *
     * @param m The ACL message to be initially displayed
     * @param parent The parent window of the dialog window
     * @return The ACL message displayed in the dialog window or null depending
     * on whether the user close the window by clicking the OK or Cancel button
