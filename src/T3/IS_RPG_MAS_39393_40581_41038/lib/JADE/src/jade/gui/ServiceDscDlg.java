...
public class ServiceDscDlg extends JDialog {
     ...
     * @param checkMandatorySlots true to force the check of the mandatory
     * slots, false otherwise
     * @return a ServiceDescription if the Ok button is pressed, false
     * otherwise.
     */
    ...
    /**
     * Return the string relative to service description fields if not empty,
     * null otherwise
     */
