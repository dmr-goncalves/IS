 ...
 * @version $Date: 2002-12-11 10:39:45 +0100 (mer, 11 dic 2002) $ $Revision:
 * 3515 $
 */
public class UserPropertyGui extends JDialog {
    ...
    /**
     * To show a given property. The boolean parameter permits to edit the
     * fields or not. If editable the method returns a property or null (if the
     * Cancel button is pressed). If not editable returns null.
     */
