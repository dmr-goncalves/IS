...
/**
 * The <code>TimeChooser</code> class can be used to let the user define a
 * certain point in time by means of a dialog window.<p>
 * <p>
...
// THIS PART IS RELATED TO THE EDITING OF RELATIVE TIMES (NOT YET IMPLEMENTED)
    ...
    /**
     * Allow the user to view a time instant through a read-only version of this
     * dialog.
     *
