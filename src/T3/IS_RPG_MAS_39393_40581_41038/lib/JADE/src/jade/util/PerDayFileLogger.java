...
/**
 * This class is an OutputStream whose output is stored in in different files
 * according to the day it is produced. Existing files, if any, are not
 * rewritten as output is appended at the end of the file.
 *
...
public class PerDayFileLogger extends PrintStream {
    ...
    /**
     * Print a Java object and a newline to the proper file, replacing the file
     * every new day.
     *
     * @param obj The Java object to print.
     */
    ...
    /**
     * Print a string and a new line to the proper file, replacing the file
     * every new day.
     *
     * @param str THe string to print.
     */
