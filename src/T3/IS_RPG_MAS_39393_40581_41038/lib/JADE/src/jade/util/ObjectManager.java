 ...
 * classes specified in the form<br>
 * foo.Bar[key1=value1,key2=value2...] This class allows registering "Loaders"
 * for given types of objects (e.g. agents) and successively load such objects
 * using them
 */
public class ObjectManager {
    ...
    /**
     * The interface to be implemented by classes that can be registered to load
    ...
    /**
     * Convert a class-name, possibly with attached properties, into a
     * Properties object The actual class-name will be available as the value of
     * the <code>CLASS_NAME</code> property
     */
    ...
    /**
     * Register a <code>Loader</code> for a given type of object. Note that more
     * than one <code>Loader</code> can be associated to a given type of object.
     *
     * @param type The type of object the registered <code>Loader</code> is
     * associated to
    ...
    /**
     * Try to load an object of a given type by means of the loaders (if any)
     * associated to that type.
     *
     * @param extendedClassName The class of the object to load in the form
     * foo.Bar[key1=value1;key2=value2...]
     * @param type The type of object to load
     * @return The loaded object or null if no loader is suitable to load the
     * object.
