...
public class Event
        //#MIDP_EXCLUDE_BEGIN
        extends EventObject //#MIDP_EXCLUDE_END
{
  ...
  protected Object source;
     ...
     * @param type The type of the event
     * @param source The source that generated the event
     * @param info The information associated to the event. This value is
     * handled as the first parameter of the event and can be accessed using the
     * <code>getParameter(0)</code> method
     */
  ...
  public Object getSource() {
    ...
    /**
     * Blocks the calling thread until the <code>notifyProcessed()</code> method
     * is called.
     *
     * @return the result of the processing of this <code>Event</code> object as
     * set by the <code>notifyProcessed()</code> method.
     */
     ...
     *
     * @param result The result of the processing. This value is passed to the
     * waked threads as the result of the <code>waitUntilProcessed()</code>
     * method.
     */
