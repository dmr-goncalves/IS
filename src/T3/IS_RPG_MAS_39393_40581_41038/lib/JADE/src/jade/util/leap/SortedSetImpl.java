...
/**
 * The LEAP (environment-dependent) implementation of the &qote;SortedSet&qote;
 * interface. This class appears to be exactly the same in J2SE, PJAVA and MIDP.
...
public class SortedSetImpl implements SortedSet {
    ...
    /**
     * Default Constructor, creates an empty Set, according to the elements'
     * natural order.
     */
