...
/**
 *
 * An ACL object represents an Access Control List and wraps a White list and a
 * Black list, Both lists make use of regular expressions for allowing/denying
 * access to a certain resource.
 *
 * //#APIDOC_EXCLUDE_BEGIN
 *
 * Example, a ACL object is initialized as follows:  <code>
 *     ACL myacl = new ACL();
...
public class AccessControlList {
     ...
     * </ul>
     *
     * <code>isAllow("section", value)</code> returns is the client having that
     * specific value for that property is allowed.
     *
     */
    ...
    /**
     * Update this AccessControlList object reading again the white and black
     * files.
     */
    public void refresh() {
        refresh_black();
