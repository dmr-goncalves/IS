...
/**
 *
 * This class acts as a base class for all the exceptions that wrap another
 * (nested) exception. The typical usage for descendents of this class is to
 * throw them within the <code>catch</code> block for their nested exception.
 *
 * @author Giovanni Rimassa - Universita' di Parma
 * @version $Date: 2012-11-29 09:31:49 +0100 (gio, 29 nov 2012) $ $Revision:
 * 6607 $
 *
 */
public abstract class WrapperException extends Exception {
     ...
     *
     * @return The exception message, including the nested exception text if
     * present.
     */
    ...
    /**
     * Prints the stack trace of this exception. If a nested exception is
     * present, its stack trace is also printed.
     */
    //#MIDP_EXCLUDE_BEGIN
     ...
     *
     * @return the <code>Throwable</code> object that is the exception that was
     * originally thrown.
     */
