...
public class HashCache implements Map {
     ...
     * present. If the cache is already full,the oldest element is deleted.
     *
    ...
    /**
     * Tests if the specified object is a key in this hashcache. present. the
     * oldest element is deleted.
     *
     * @param o element to be added to this set.
    ...
    /**
     * Retrieves a cached element. The retrieved element is also marked as the
     * last used one, so that the cache replacement policy becomes LRU instead
     * of FIFO.
     *
     * @param o The
     */
