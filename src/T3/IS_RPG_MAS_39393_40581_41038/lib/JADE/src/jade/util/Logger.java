 ...
 * code can be used, independently of the target environment: <br><br>
 *
 ...
 * <br>
 * <code>java -Djava.util.logging.config.file=mylogging.properties jade.Boot
 * ...</code>
 *
 * <p>
 * <b>PersonaJava</b><br>
...
public class Logger
    ...
    /**
     * Initialize the logging mechanism. This method makes sense only in a PJAVA
     * or MIDP environment, but is available in J2SE too (where it does nothing)
     * to provide a uniform interface over the different Java environments.
     */
