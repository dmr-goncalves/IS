 ...
 * &qote;java.util.ArrayList&qote; class. This class appears to be exactly the
...
public class ArrayList implements List, Serializable {
    ...
    /**
     * Fill this list with the content of a given <code>java.util.List</code>
     * object.
     *
     * @param l The <code>java.util.List</code> to copy the content from.
     */
