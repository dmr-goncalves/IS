 ...
 * &qote;java.util.Properties&qote; class. This class appears to be exactly the
 * same in J2SE, PJAVA and MIDP. The internal implementation is different in the
 * three cases however. In particular the J2SE and PJAVA implementation simply
 * extend java.util.Properties. In particular the MIDP version re-implement the
 * load and store methods to access properties from the .jad file of the midlet
 * or from a properly formatted RecordStore (see the <code>load()</code> and
 * <code>store</code> methods.
 *
...
public class Properties extends java.util.Properties implements Serializable {
    ...
    /**
     * This is required to ensure compatibility with the J2ME version of this
     * class in serialization/deserialization operations.
     */
...
#MIDP_INCLUDE_END*/
    ...
    /**
     * Load a set of key-value pairs from a given storage element. All key-value
     * pairs previously included in this Properties object will be lost. The
     * storage element is environment-dependent: In a J2SE or PJAVA environment
     * it is a file named <code>storage</code>. In a MIDP environment it can be
     * the JAD of the MIDlet (if <code>storage</code> = "jad") or a RecordStore
     * called <code>storage</code>.
     */
    ...
    /**
     * Store the set of key-value pairs held by this Properties object into a
     * given storage element. The storage element is environment-dependent: In a
     * J2SE or PJAVA environment it is a file named <code>storage</code>. In a
     * MIDP environment it is a RecordStore called <code>storage</code>.
     */
