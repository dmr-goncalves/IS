...
/**
 * This class wraps a Transport Address and implements the equals() and
 * hashCode() methods so that two Transport Addresses representing the same
 * address, even if possibly expressed in different forms, are actually
 * considered equals.
 *
 * @author 00917536
 *
