...
public class BootGUI extends JDialog {
    ...
    /**
     * Update the gui when a new file is opened. For every property it sets in
     * the vector of property the value read in the file or if it is absent the
     * default value.
     */
    ...
    /**
     * Verify if the file written by the user has the right extension. (Used in
     * the save action)
     */
