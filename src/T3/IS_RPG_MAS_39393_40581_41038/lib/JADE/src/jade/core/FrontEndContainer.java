...
class FrontEndContainer implements FrontEnd, AgentToolkit, Runnable {
    ...
    /**
     * Start this FrontEndContainer creating agents and services and connecting
     * to the BackEnd.
     */
     ...
     * name is received before the actual agent name is assigned --> This method
     * is called in messageIn() and other agent-related methods to avoid that.
     */
