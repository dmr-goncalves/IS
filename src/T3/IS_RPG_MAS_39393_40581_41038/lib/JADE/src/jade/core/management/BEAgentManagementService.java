 ...
 * suspension and resumption, in the special case of a Back-End Container.
 *
...
public class BEAgentManagementService extends BaseService {
    ...
    private class CommandTargetSink implements Sink {
        ...
        /**
         * Force the creation of an agent on the FrontEnd. Note that the agent
         * to create can have a different owner with respect to the owner of
         * this "container" --> Its image holding the agent's ownership
         * information must be created now and not in the bornAgent() method.
         * This image is stored in the pendingImages map for later retrieval
         * (see bornAgent()).
         */
    ...
    /**
     * Inner mix-in class for this service: this class receives commands from
     * the service <code>Sink</code> and serves them, coordinating with remote
     * parts of this service through the <code>Service.Slice</code> interface.
     */
