...
public interface IMTPManager {
     ...
     *
     * @param mgr The <code>ServiceManager</code> implementation that is to be
    ...
    /**
     * Stops making the platform <i>Service Manager</i> available through this
     * IMTP.
     *
     * @throws IMTPException If something goes wrong in the underlying network
     * transport.
     ...
     *
     * @param itfs The array of all the interfaces that have to be implemented
     * by the returned proxy. The first element of the array must be an
     * interface derived from <code>Service.Slice</code>.
     * @return A proxy object that can be safely casted to any of the interfaces
     * in the <code>itfs</code> array.
     * @throws IMTPException If something goes wrong in the underlying network
     * transport.
     *
