...
/**
 * An implementation of this interface is used by the FaultRecoveryService to
 * save the information required to recover a platform after a fault of the Main
 * Container.
 *
...
public interface PersistentStorage {
    ...
    /**
     * Close this persistent storage performing all necessary clean-up
     * operations
     */
    void close();
    ...
    /**
     * Retrieve the Platform Information i.e. Platform name and Main Ccntainer
     * local address
     */
