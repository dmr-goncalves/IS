...
public interface PersistentDeliverySlice extends Service.Slice {
    ...
    /**
     * This command name represents the action of activating a message store for
     * undelivered ACL messages, on the specified node.
     */
    //static final String ACTIVATE_MESSAGE_STORE = "Activate-Message-Store";
    /**
     * This command name represents the action of deactivating a message store
     * for undelivered ACL messages, on the specified node.
     */
     ...
     * template to a message store, so that undelivered ACL messages addressed
     * to that ID will be retained.
     */
    //static final String REGISTER_MESSAGE_TEMPLATE = "Register-Message-Template";
    /**
     * This command name represents the action of removing a given message
     * template from a message store. This stops the retention of undelivered
     * ACL messages for that agent ID.
     */
