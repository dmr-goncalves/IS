...
/**
 * This ClassLoader is intended to be used to load agent classes packed within a
 * jar file. If the specified jar does not exist this ClassLoader will attempt
 * to load classes from the system ClassLoader.
 *
...
public class JarClassLoader extends ClassLoader {
     ...
     *
     * public InputStream getResourceAsStream(String name) { if (_jarFile !=
     * null) {
     *
     * ZipEntry zEntry = _jarFile.getEntry(name);
     *
     * try { if (zEntry != null) { return _jarFile.getInputStream(zEntry); }
    ...
    /**
     * Clean up the JarClassLoader. This means closing the JAR file if it has
     * not explicitly done before by using the provided close() method.
     */
