...
/**
 * Base service for services that implements ad hoc node monitoring mechanisms
 * such as the UDPNodeMonitoringService
 */
public abstract class NodeMonitoringService extends BaseService {

    /**
     * Vertical command issued on the Main Container when a peripheral node
     * becomes unreachable
     */
    public static final String NODE_UNREACHABLE = "Node-Unreachable";
    /**
     * Vertical command issued on the Main Container when a peripheral node
     * returns reachable after being unreachable for a while
     */
