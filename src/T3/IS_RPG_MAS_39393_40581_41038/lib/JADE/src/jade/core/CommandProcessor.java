...
class CommandProcessor {
     ...
     *
     * @param snk A service-specific implementation of the <code>Sink</code>
     * interface, managing a set of vertical commands.
     ...
     *
     * @param side One of the two constants <code>Sink.COMMAND_SOURCE</code> or
     * <code>Sink.COMMAND_TARGET</code>, to state whether the sink to be removed
     * is handling locally issued commands or commands incoming from remote
     * nodes.
     * @param commandNames An array containing all the names of the vertical
     * commands currently handled by the sink to be removed.
     * @throws ServiceException If a member of the <code>commandNames</code> set
     * has no associated command sink.
     */
     ...
     * represents. This method is not synchronized and it must be reentrant and
     * as fast as possible, because it is going to be a bottleneck of the kernel
     * call flow.
     *
