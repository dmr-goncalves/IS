 ...
 * <p>
 * <code>name<b>:</b>className<b>(</b><i>separated
 * arglist</i><b>)</b></code></p>
...
public class Specifier {
    ...
    /**
     * This method is used by Boot, ProfileImpl, and RMA in order to have a
     * String representation of this Specifier according to the format
     * <code>name:className(arg1 arg2 argn)</code>
     *
     * @return A string representation of this specifier, according to the
     * format above.
     *
     */
    ...
    /**
     * This static utility method can parse the string representation of a list
     * of specifiers. The general format of a specifier is used, with a comma as
     * argument separator, i.e.:
     * <p>
     * <code>name<b>:</b>className<b>(</b><i>comma-separated
     * arglist</i><b>)</b></code></p>
     ...
     * @param argsDelimiter The character to use as a delimiter within the
     * argument list.
