...
public abstract class TickerBehaviour extends SimpleBehaviour {
    ...
    /**
     * Turn on/off the "fixed period" mode. Given a period P, when fixed period
     * mode is off (default), this behaviour will wait for P milliseconds from
     * the end of the n-th execution of the onTick() method to the beginning of
     * the n+1-th execution. When fixed period is on, this behaviour will
     * execute the onTick() method exactly every P milliseconds.
     *
     * @param fixedPeriod A boolean value indicating whether the fixed period
