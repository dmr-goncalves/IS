...
/**
 *
 * Abstract interface to represent JADE network locations. This interface can be
 * used to access information about the various places where a JADE mobile agent
 * can migrate.
 *
 * @author Giovanni Rimassa - Universita` di Parma
 * @version $Date: 2002-02-04 11:31:40 +0100 (lun, 04 feb 2002) $ $Revision:
 * 3043 $
 */
public interface Location extends Serializable, Concept {
     ...
     *
     * @return The transport address of this location (in the specified
     * protocol).
     */
    String getAddress();
