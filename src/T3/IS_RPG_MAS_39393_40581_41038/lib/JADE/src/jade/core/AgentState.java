...
public class AgentState {
    ...
    /**
     * Static access method to retrieve a prototype object for an agent
     * life-cycle state.
     *
    ...
    /**
     * Equality operations between agent states. The equality operation is
     * defined as equality by state name (case insensitive string comparison is
     * used).
     *
     * @param o The right-hand side of the equality.
     * @return If the current object and the parameter are equal (according to
     * the criterion above), this method returns <code>true</code>, otherwise it
    ...
    /**
     * Compares two agent states. A lexicographical, case insensitive comparison
     * on state name is used.
     *
     * @param o The object to compare the current object to.
     * @return An integer value, <code>-1</code>, <code>0</code> or
     * <code>1</code> depending upon whether the current object is lesser, equal
     * or greater than the given parameter.
     ...
     *
     * @return An integer value, complying with the defined equality operation
     * on <code>AgentState</code> instances.
     */
    public int hashCode() {
