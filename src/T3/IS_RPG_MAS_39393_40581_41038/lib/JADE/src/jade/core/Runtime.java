...
public class Runtime {
    ...
    /**
     * This method returns the singleton instance of this class that should be
     * then used to create agent containers.
     *
     */
    ...
    //#MIDP_EXCLUDE_BEGIN
    /**
     * Creates a new agent container in the current JVM, providing access
     ...
     * container
     * @return A proxy object, through which services can be requested from the
     * real JADE container.
     * @exception IllegalStateException if the Single-container modality was
     * previously activated by calling the <code>startUp()</code> method.
     */
    ...
    /**
     * Creates a new main container in the current JVM, providing access through
     * a proxy object.
     * <br>
     * <b>NOT available in MIDP</b>
     * <br>
    ...
    /**
     * Starts a JADE container in the Single-container modality. Successive
     * calls to this method will take no effect.
     *
     * @param p the profile containing boostrap and configuration data for this
     * container
     * @exception IllegalStateException if the Multiple-container modality was
     * previously activated by calling the <code>createAgentContainer()</code>
    ...
    //#APIDOC_EXCLUDE_BEGIN
    /**
     * Return a String with copyright Notice, Name and Version of this version
     * of JADE
     */
