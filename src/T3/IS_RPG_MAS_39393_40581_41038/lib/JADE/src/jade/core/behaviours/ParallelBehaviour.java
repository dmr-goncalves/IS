...
public class ParallelBehaviour extends CompositeBehaviour {
    ...
    /**
     * Predefined constant to be used in the constructor to create a
     * <code>ParallelBehaviour</code> that terminates when any of its child is
     * done.
     */
    ...
    /**
     * Construct a <code>ParallelBehaviour</code> without setting the owner
     * agent, and using the default termination condition (i.e. the parallel
     * behaviour terminates as soon as all its children behaviours terminate.
     */
    ...
    /**
     * Handle block/restart notifications. A <code>ParallelBehaviour</code>
     * object is blocked
     * <em>only</em> when all its children behaviours are blocked and becomes
     * ready to run as soon as any of its children is runnable. This method
