 ...
 * waits at port 28000 for incomming UDP datagrams. The maximum time between two
 * ping messages is by default 3 second. After 5 seconds a node is marked for
...
class UDPMonitorServer {
    ...
    /**
     * Class to store a deadline for the next ping of a targeted node
     */
    ...
    /**
     * Registers a <code>UDPNodeFailureMonitor</code>. All nodes targeted by
     * this monitor are now supervised by the <code>UDPMonitorServer</code>. Its
     * listener gets informed about any state changes.
     */
    ...
    /**
     * Deregisters a <code>UDPNodeFailureMonitor</code> and all its targeted
     * nodes from monitoring.
     */
    ...
    /**
     * This method is invoked by a PingHandler thread when a new ping message
     * has been received
     *
