...
public class MainReplicationService extends BaseService {
    ...
    /**
     * This method is invoked when the monitored main node remains unreachable
     * for too long and is therefore considered dead. The default implementation
     * simply returns REMOVE_NODE so that the node is removed. Subclasses may
     * redefine this method to implement application-specific checks aimed at
     * detecting whether the unreachability depends on a real death or on
     * temporary network problems and returns different actions according to the
     * situation.
     *
    ...
    /**
     * Inner class CommandOutgoingFilter Keep tool agents information in synch
     * among replicas
     */
    ...
    /**
     * Inner class CommandIncomingFilter Keep agents and MTPs information in
     * synch among replicas
     */
