...
/**
 * Base class for behaviours intended to request the execution of an action to a
 * given actor and get back the result (if any)
 *
 * @param <ActionT> The class of the action to be executed
 * @param <ResultT> The class of the result or Void if the action is not
