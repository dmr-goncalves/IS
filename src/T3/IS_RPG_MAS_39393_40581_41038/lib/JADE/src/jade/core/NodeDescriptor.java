...
public class NodeDescriptor implements Serializable {
    ...
    /**
     * Builds a new node descriptor, describing the given node with the given
     * name and properties.
     *
     ...
     *
     * @return The name of the described node, or <code>null</code> if no name
     * was set.
     */
     ...
     *
     * @param node The <code>Node</code> object that is to be described by this
     * node descriptor.
     */
     ...
     *
     * @return The <code>Node</code> object described by this node descriptor,
     * or <code>null</code> if no node was set.
     */
    public Node getNode() {
        return myNode;
    }
     ...
     *
     * @return The principal of the owner of this node, or <code>null</code> if
     * no principal was set.
     */
     ...
     *
     * @return The credentials of the owner of this node, or <code>null</code>
     * if no credentials were set.
     */
