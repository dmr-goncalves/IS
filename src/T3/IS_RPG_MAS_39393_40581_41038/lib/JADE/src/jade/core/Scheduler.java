 ...
 * @version $Date: 2005-12-16 16:37:25 +0100 (ven, 16 dic 2005) $ $Revision:
 * 5844 $
 */
/**
 * ************************************************************
 ...
 *
 * + Selects the behaviour to execute. (Behaviour)
 *
 * + Holds together all the behaviours of an agent. (Agent, Behaviour)
 *
...
class Scheduler implements Serializable {
    ...
    /**
     * Restarts all behaviours. This method simply calls Behaviour.restart() on
     * every behaviour. The Behaviour.restart() method then notifies the agent
     ...
     * behaviours? Some ready behaviour can be a ParallelBehaviour with some of
    ...
    public synchronized void restartAll() {
        ...
        int counter = 0;
        //#MIDP_EXCLUDE_BEGIN
        for (Iterator it = readyBehaviours.iterator(); it.hasNext();) //#MIDP_EXCLUDE_END
        /*#MIDP_INCLUDE_BEGIN
