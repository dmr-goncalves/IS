...
/**
 * Utility class the provides simplified access to the method-replication
 * feature of the AgentReplicationService.
 */
public class AgentReplicationHandle {
    ...
    /**
     * Checks whether we are inside the execution of a replicated or original
     * call.
     */
