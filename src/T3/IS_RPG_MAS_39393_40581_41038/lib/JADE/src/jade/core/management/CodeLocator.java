 ...
 *
 * The access to the methods should be made inside a synchronized block against
 * the CodeLocator instance.
 *
...
public class CodeLocator {
     ...
     * @param localCode Indicates the code is local (i.e. has not get to by any
     * migration service) and cannot be modified.
     * @throws Exception
     */
     ...
     * @param name Agent name.
     * @param cl Agent associated classloader.
     * @return True - Agent is updated. False - Agent cannot be updated.
     * @throws Exception
     */
     ...
     *
     * @param name Agent name.
     * @return True - The agent is registered. False - The agent is not
     * registered.
     */
     ...
     *
     * @param cle Class with a method per event which should be overloaded by
     * users.
     */
     ...
     * @return True - Unsubscription ok. False - Subscription not found.
     */
