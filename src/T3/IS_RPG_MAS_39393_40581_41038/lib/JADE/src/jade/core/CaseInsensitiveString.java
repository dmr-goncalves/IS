 ...
 * @version $Date: 2005-10-28 14:20:41 +0200 (ven, 28 ott 2005) $ $Revision:
 * 5806 $
 *
...
public class CaseInsensitiveString implements Serializable {
     ...
     * <code>CaseInsensitiveString</code> object with another or with a Java
     * <code>String</code>. The comparison is case insensitive.
     *
     ...
     * <code>CaseInsensitiveString</code> objects differing only in case have
     * the same hash code.
     *
    ...
    /**
     * Static method for case insensitive string comparasion. For comparasion
     * used the regionMatches approach which doesn't allocate any additional
     * memory.
     *
