...
public class TopicManagementService extends BaseService {
    ...
    /**
     * Inner class CommandOutgoingFilter. Intercepts the SEND_MESSAGE VCommand
     * and broadcast messages directed to a topic to all agents interested in
     * that topic
     */
    ...
    //////////////////////////////////////////////////
    /**
     * If the dead agent was interested in some topic, notify all slices that
     * its interest is no longer valid
     */
    ...
    /**
     * If the new slice is a TopicManagementSlice notify it about all current
     * registrations
     */
    ...
    /**
     * The Main lost all information about the local node --> Notify the Main
     * slice about all local registrations
     */
