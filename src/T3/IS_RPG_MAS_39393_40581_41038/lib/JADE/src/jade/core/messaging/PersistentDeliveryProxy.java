...
/**
 * The remote proxy for the JADE kernel-level service managing a persistent
 * message delivery subsystem installed in the platform. A persistent message
 * delivery is able to deliver an ACL message across an agent lifecycle, as long
 * as the agent ID stays the same.
 *
