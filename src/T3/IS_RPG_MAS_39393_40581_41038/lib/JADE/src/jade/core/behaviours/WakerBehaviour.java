 ...
 * <li> the method  <code>handleElapsedTimeout</code> must implement the task
 * that will be executed after the timeout is elapsed.
 * </ul>
 *
...
public abstract class WakerBehaviour extends SimpleBehaviour {
     ...
     *
     * @param a is the pointer to the agent
     * @param timeout indicates the number of milliseconds after which the task
     * must be executed
     */
     ...
     * Calling stop() has the same effect as removing this WakerBehaviour, but
     * is Thread safe
     */
    public void stop() {
        finished = true;
