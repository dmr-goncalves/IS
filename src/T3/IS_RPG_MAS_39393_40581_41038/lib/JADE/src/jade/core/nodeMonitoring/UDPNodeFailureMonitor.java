...
class UDPNodeFailureMonitor extends NodeFailureMonitor {
    ...
    /**
     * The target is connected. That means that it is sending ping messages
     * regulary.
     */
    public static final int STATE_CONNECTED = 0;

    /**
     * The target is unreachable. The target doesn't send ping messages any
     * more.
     */
    public static final int STATE_UNREACHABLE = 1;

    /**
     * The final state. The target isn't monitored anymore.
     */
    ...
    /**
     * Returns the time when the last ping message has been received from the
     * targeted node
     *
    ...
    /**
     * Sets the time when the last ping message has been received from the
     * targeted node
     *
     * @param time the difference, measured in milliseconds, between the current
     * time and midnight, January 1, 1970 UTC.
     */
