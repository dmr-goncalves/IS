...
public abstract class Filter {
     ...
     * of the command or previous filters in the chain).
     */
     ...
     * <code>false</code> from this method. A vetoed command is not propagated
     * in the filter chain.
     */
    ...
    /**
     * Inquires the blocking state of this filter. A blocked fliter does not
     * process commands, and also prevents subsequent filters to process them.
     *
    ...
    /**
     * Inquires the skipping state of this filter. A skipped filter does not
     * process commands, but passes them directly to subsequent filters.
     *
