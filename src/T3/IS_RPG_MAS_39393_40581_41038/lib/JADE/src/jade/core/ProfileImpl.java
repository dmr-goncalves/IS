...
public class ProfileImpl extends Profile {
    ...
    /**
     * Creates a Profile implementation with the following default
     * configuration:
     * <br> if isMain is true, then the profile is configured to launch a
     * main-container on the localhost, RMI internal Message Transport Protocol,
     * port number 1099, HTTP MTP.
     * <br> if isMain is false, then the profile is configured to launch a
     * remote container on the localhost, connecting to the main-container on
     * the localhost through RMI internal Message Transport Protocol, port
     * number 1099.
     */
    ...
    /**
     * Create a Profile object initialized with the settings specified in a
     * given property file
     */
     ...
     * (<b>i.e. a main container!!</b>).
     *
     * @param host is the name of the host where the main-container should be
     * listen to. A null value means use the default (i.e. localhost)
     * @param port is the port number where the main-container should be listen
     * for other containers. A negative value should be used for using the
     * default port number.
     * @param platformID is the symbolic name of the platform, if different from
     * default. A null value means use the default (i.e. localhost)
     *
     */
    ...
    /**
     * This constructor creates a default Profile for launching a main (or
     * non-main) container (depending on the value of <code>isMain</code>)
     *
     * @param host is the name of the host where the main-container should be
     * listen to. A null value means use the default (i.e. localhost)
     * @param port is the port number where the main-container should be listen
 ...
 /*#MIDP_INCLUDE_BEGIN
     ...
     * parameter corresponding to the specified key is found,
     * <code>aDefault</code> is returned.
     *
     * @param key The key identifying the parameter to be retrieved among the
     * configuration properties.
     * @param aDefault The value that is returned if the specified key is not
     * found
     */
    ...
    /**
     * Creates a string representation of this profile. The returned string has
     * the format
     * <p>
     * <code>(profile name1=value1 name2=value2 ... )</code></p>
     *
     * @return A string containing a readable representation of this profile
     * object.
     */
     ...
     * remote proxy object.
     * @throws ProfileException If some needed information is wrong or missing
     * from the profile.
     */
