 ...
 * JADE platform <i>Service Manager</i> and
 * <i>Service Finder</i> components. It holds a set of services and manages
 * them.
 *
...
public class PlatformManagerImpl implements PlatformManager {
     ...
     * JADE profile. This constructor is package-scoped, so that only the JADE
     * kernel is allowed to create a new Service Manager implementation.
     *
     ...
     * @param propagated Flag indicating whether the new-node event was a
     * propagated event within the replication mechanism
     */
    ...
    /**
     * This method is invoked by the MainReplicationService when a new
     * MainReplication slice is added and has the effect of issuing a NEW_NODE
     * VCommand and one NEW_SLICE VCommand for each service installed in the
     * node hosting the new MainReplication slice. This allows services to
     * propagate service specific information to their new slice
     */
    ...
    /**
     * Inner class NodeInfo. Embeds the node descriptor and the services
     * currently installed on the node
     */
