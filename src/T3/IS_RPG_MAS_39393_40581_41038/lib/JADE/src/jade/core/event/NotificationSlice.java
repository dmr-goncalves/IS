...
/**
 * The horizontal interface for the JADE kernel-level service managing the event
...
public interface NotificationSlice extends Service.Slice {
    ...
    /**
     * This command name represents the action of activating an instance of the
     * Sniffer agent.
     */
    static final String SNIFF_ON = "Sniff-On";

    /**
     * This command name represents the action of deactivating a previously
     * started instance of the Sniffer agent.
     */
