...
/**
 *
 * The <code>ServiceDescriptor</code> class serves as a meta-level description
 * of a kernel-level service. Instances of this class contain a
 * <code>Service</code> object, along with its name and properties, and are used
 * in service management operations, as well as in agent-level introspection of
...
public class ServiceDescriptor implements Serializable {
    ...
    /**
     * Builds a new service descriptor, describing the given service with the
     * given name and properties.
     *
     ...
     *
     * @return The name of the described service, or <code>null</code> if no
     * name was set.
     */
     ...
     *
     * @param svc The <code>Service</code> object that is to be described by
     ...
     *
     * @return The <code>Service</code> object described by this service
     * descriptor, or <code>null</code> if no service was set.
     */
