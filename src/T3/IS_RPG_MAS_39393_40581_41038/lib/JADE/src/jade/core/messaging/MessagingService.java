...
public class MessagingService extends BaseService implements MessageManager.Channel {
     ...
     *
     * @param myProfile The <code>Profile</code> instance containing the list of
     * ACL codecs and MTPs to activate on this node.
    ...
    /**
     * Inner class CommandSourceSink This inner class handles the messaging
     * commands on the command issuer side, turning them into horizontal
     * commands and forwarding them to remote slices when necessary.
     */
    ...
    private class CommandTargetSink implements Sink {
        ...
        private MTPDescriptor installMTP(String address, String className) throws IMTPException, ServiceException, MTPException {
            ...
            try {
			 ...
			 #DOTNET_INCLUDE_END*/ catch (ClassNotFoundException cnfe) {
