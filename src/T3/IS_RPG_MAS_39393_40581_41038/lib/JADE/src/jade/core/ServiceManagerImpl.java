...
public class ServiceManagerImpl implements ServiceManager, ServiceFinder {
    ...
    /**
     * This method implements the platform reattachement procedure that is
     * activated after a fault and a successive recover of the Main Container.
     *
    ...
    /**
     * This method implements the main reconnection procedure that is activated
     * when the main container this container is connected to crashes and a
     * backup main container becomes the leader.
     *
