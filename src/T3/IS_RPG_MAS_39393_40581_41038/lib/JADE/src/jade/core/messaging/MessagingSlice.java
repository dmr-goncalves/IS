...
public interface MessagingSlice extends Service.Slice {
    ...
    /**
     * This command name represents the action of sending an ACL message from an
     * agent to another.
     */
    static final String SEND_MESSAGE = "Send-Message";

    /**
     * This command name represents the action of sending back a FAILURE ACL
     * message to notify the message originator of a failed delivery.
     */
