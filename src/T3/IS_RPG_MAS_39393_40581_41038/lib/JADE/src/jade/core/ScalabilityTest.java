...
public class ScalabilityTest {
    ...
    /**
     * Inner class BitrateSenderAgent Send messages to the corresponding
     * receiver. When the receiver gets message 0 takes the START time. When the
     * receiver gets message N (number of iterations) takes the END time and
     * completes
     */
     ...
     * For each message waits for the response and compute the round trip time.
     */
