...
public abstract class CompositeBehaviour extends Behaviour {
    ...
    /**
     * Executes this <code>CompositeBehaviour</code>. This method executes
     * children according to the scheduling policy defined by concrete
     * subclasses that implements the <code>scheduleFirst()</code> and
     * <code>scheduleNext()</code> methods.
     */
    ...
    /**
     * This methods is called after the execution of each child in order to
     * check whether the <code>CompositeBehaviour</code> should terminate.
     *
     * @param currentDone a flag indicating whether the just executed child has
     * completed or not.
     * @param currentResult the termination value (as returned by
     * <code>onEnd()</code>) of the just executed child in the case this child
     * has completed (otherwise this parameter is meaningless)
     * @return true if the <code>CompositeBehaviour</code> should terminate.
     * false otherwise.
     */
     ...
     * internal state is cleaned up and <code>reset()</code> is recursively
     * called for each child behaviour.
     */
    public void reset() {
        resetChildren();
    ...
    /**
     * Associates this behaviour with the agent it belongs to. Overrides the
     * method in the base class to propagate the setting to all children.
     *
     * @param a The agent this behaviour belongs to.
