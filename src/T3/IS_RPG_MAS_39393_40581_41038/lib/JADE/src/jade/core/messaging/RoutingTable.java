...
class RoutingTable {
    ...
    /**
     * Inner class MTPInfo This class just provides the association between a
     * local MTP and its descriptor
     */
    class MTPInfo {
    ...
    /**
     * Adds a new locally installed MTP for the URL named <code>url</code>.
     */
    ...
    /**
     * Removes a locally installed MTP for the URL named <code>url</code>.
     */
    ...
    /**
     * Retrieves an outgoing channel object suitable for reaching the address
     * <code>url</code>.
     */
