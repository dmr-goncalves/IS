...
public class SAMInfo implements Serializable {
    ...
    /**
     * Provides the differential values of all monitored counters in form of a
     * Map.
     *
     * @return A Map mapping monitored counter names to their differential
     * values
     */
    ...
    /**
     * If there are entities/counters of the form a#b, a#c... produce an
     * aggregated entity a. Since a itself may have the form a1#a2, iterate
     * until there are no more aggregations
     */
