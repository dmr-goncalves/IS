...
/**
 * ServiceHelper provided by the MessagingService to make additional messaging
...
public interface MessagingHelper extends ServiceHelper {
     ...
     * This methods can only be invoked in a Main Container. Invoking that
     * method in a peripheral container results in a ServiceException
     *
    ...
    /**
     * De-register a listener previously registered to be notified about alias
     * creation/deletion. This methods can only be invoked in a Main Container.
     * Invoking that method in a peripheral container results in a
     * ServiceException
     *
