...
public abstract class BaseInitiator extends AchieveREInitiator {
     ...
     * description of the target agent of this behaviour. Such description will
     * be used in all default error messages.
     *
     * @return A human readable description of the target agent of this
     * behaviour
     */
