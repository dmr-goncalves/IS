...
public class LoaderBehaviour extends Behaviour {
    ...
    /**
     * Construct a LoaderBehaviour to be executed by a given agent and that will
     * use a given class loader to load behaviours whose code is not embedded in
     * the LoadBehaviour request.
     */
    ...
    /**
     * Add a loaded behaviour to the agent. Subclasses may redefine this method
     * to handle the behaviour addition operation in an application specific
     * way.
     *
    ...
    /**
     * Suclasses may redefine this method to prevent the behaviour loading
     * operation under specific conditions. This default implementation always
    ...
    /**
     * Inner class ResultCollector. This behaviour restores the output
     * parameters at the end of the execution of the loaded behaviour and sends
     * back the result notification to the requester.
     */
