...
/**
 * This class represents an exception related to JADE profile creation or
 * management.
 *
...
public class ProfileException extends WrapperException {
    ...
    /**
     * Constructs a <code>ProfileException</code> with the specified detail
     * message, wrapping the given <code>Throwable</code>object.
     *
