...
/**
 * This class supports the ACL persistent delivery service, managing actual ACL
 * messages storage, scheduled message delivery and other utility tasks related
 * to the service.
 *
