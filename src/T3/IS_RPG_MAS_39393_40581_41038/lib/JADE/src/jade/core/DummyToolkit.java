...
/**
 * This is a degenerate toolkit which is used before the actual one is setup or
 * during agent termination. Every method which returns an object will return
 * null and all others do nothing.
 *
