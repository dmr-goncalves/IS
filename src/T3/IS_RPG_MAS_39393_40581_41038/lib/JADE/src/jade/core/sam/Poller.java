...
class Poller extends Thread {
    ...
    /**
     * This is the method that produces a new record for each monitored
     * entity/counter. It is invoked periodically by the poller Thread. At each
     * invocation it retrieves the relevant information from each SAM Service
     * slice.
     */
    void poll() {
