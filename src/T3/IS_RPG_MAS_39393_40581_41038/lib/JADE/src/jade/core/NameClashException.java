 ...
 * @version $Date: 2005-01-10 17:14:29 +0100 (lun, 10 gen 2005) $ $Revision:
 * 5513 $
 */
public class NameClashException extends Exception {

    /**
     * This constant string is used to distinguish a name clash from other
     * reasons that may prevent the creation of an agent.
     */
