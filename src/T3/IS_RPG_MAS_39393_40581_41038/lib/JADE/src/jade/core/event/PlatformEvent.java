 ...
 *
 * @version $Date: 2006-02-21 08:56:26 +0100 (mar, 21 feb 2006) $ $Revision:
 * 5860 $
 */
public class PlatformEvent extends JADEEvent implements jade.wrapper.PlatformEvent {
     ...
     * added, deleted, or requested to be killed. If the id parameter is not
     * either {@link #ADDED_CONTAINER ADDED_CONTAINER} or
     * {@link #REMOVED_CONTAINER REMOVED_CONTAINER}, an
     * {@link jade.domain.FIPAAgentManagement.InternalError InternalError}
     * exception will be thrown.
     * <p>
     * The {@link #getContainer() getContainer()} method can be used to get the
     * target container. The {@link #getAgent() getAgent()} and
     * {@link #getNewContainer() getNewContainer()} methods will both return
     * null.
     * <p>
    ...
    /**
     * This constructor is used to create a PlatformEvent when an agent is born
     * or dies. If the id parameter is not either null null null     {@link #BORN_AGENT BORN_AGENT}, {@link #DEAD_AGENT DEAD_AGENT},
     ...
     * <p>
     * The {@link #getContainer() getContainer()} method can be used to get the
     * event source. The {@link #getNewContainer() getNewContainer()} method
     * will return null for a {@link #BORN_AGENT BORN_AGENT},
     * {@link #DEAD_AGENT DEAD_AGENT},
     * {@link #SUSPENDED_AGENT SUSPENDED_AGENT} or
     * {@link #RESUMED_AGENT RESUMED_AGENT} event.
     * <p>
     * @param id The event ID must be either null null null     {@link #BORN_AGENT BORN_AGENT},
	 * {@link #DEAD_AGENT DEAD_AGENT},
     * {@link #SUSPENDED_AGENT SUSPENDED_AGENT} or
     ...
     * container ID of the container where the agent was born or died should be
     * passed, even though the main container is the object that will acutally
     * generate the event.
     * <p>
     * @see #getContainer()
     * @see #getAgent()
     ...
     * {@link #getContainer() getContainer()} method can be used to get the
     * event source. The {@link #getNewContainer() getNewContainer()} method
     * will return the container ID of the container to which agent is moved.
     * <p>
    ...
    /**
     * Returns the {@link jade.core.ContainerID ContainerID} of the event
     * source.
     * <p>
     * In the case of {@link #ADDED_CONTAINER ADDED_CONTAINER} or
     * {@link #REMOVED_CONTAINER REMOVED_CONTAINER} the event source will always
     * be the main container since the addition or deletion of a container is
     * essentially an action in the main container.
     * <p>
     * In the case of the a {@link #BORN_AGENT BORN_AGENT} or
     * {@link #DEAD_AGENT DEAD_AGENT} event, the event source will be the
     * container where the agent was born or died.
     * <p>
     * In the case a {@link #MOVED_AGENT MOVED_AGENT} event, the event source is
     * the container from which the agent departed. The container to which the
     * agent moved can be retrieved using the
     * {@link #getNewContainer() getNewContainer()} method.
     * <p>
     * @return The {@link jade.core.ContainerID ContainerID} of the event
     * source.
     * @see #getNewContainer()
     */
     ...
     * which an agent moved when the event type is
     * {@link #MOVED_AGENT MOVED_AGENT}. For all other event types, this method
     * returns null.
     * <p>
    ...
    /**
     * Returns the {@link jade.core.AID AID} of the agent that was born, died,
     * or moved. If the event type is either
     * {@link #ADDED_CONTAINER ADDED_CONTAINER} or
     * {@link #REMOVED_CONTAINER REMOVED_CONTAINER}, this method returns null
     * since there is no agent involved.
     * <p>
     * @return The {@link jade.core.AID AID} of the agent that was born, died,
     * or moved.
     * @see #getContainer()
     */
    public AID getAgent() {
     ...
     * {@link #ADDED_CONTAINER ADDED_CONTAINER} or
     * {@link #REMOVED_CONTAINER REMOVED_CONTAINER}, otherwise, false is
     * returned.
     */
     ...
     * <p>
     * @return True if the event type is either {@link #BORN_AGENT BORN_AGENT}
     * or {@link #DEAD_AGENT DEAD_AGENT}, otherwise, false is returned.
     */
    ...
    /**
     * Returns the event type which will be one of null null null     {@link #ADDED_CONTAINER ADDED_CONTAINER},
	 * {@link #REMOVED_CONTAINER REMOVED_CONTAINER},
