...
//#J2ME_EXCLUDE_FILE
/**
 * This interface should be implemented by classes used by the
 * UDPNodeMonitoringService to check whether the lack of UDP ping packets from a
 * given node depends on an actual fault of the monitored node or on a network
 * disconnection.
 *
