...
/**
 * Common base class for all classes implementing the Single Session version of
 * the Responder role in interaction protocols where the responder is expected
 * to receive more than one message from the initiator and reply to each of
 * them.
 *
...
abstract class SSResponder extends FSMBehaviour {
    ...
    /**
     * This method can be redefined by protocol specific implementations to take
     * proper actions after the completion of the current protocol session.
     */
