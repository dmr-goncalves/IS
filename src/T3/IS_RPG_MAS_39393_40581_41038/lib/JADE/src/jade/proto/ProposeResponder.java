 ...
 * <code>fipa-propose</code> interaction protocol from the point of view of a
 * responder to a propose (<code>propose</code>) message.<p>
 ...
 * <code>ACCEPT_PROPOSAL</code> reply message. Any other type of returned
 * communicative act is sent and then closes the protocol.
 * <p>
...
public class ProposeResponder extends FSMBehaviour implements FIPANames.InteractionProtocol {
     ...
     * defines what messages this ProposeResponder will react to and reset the
     * protocol.
     */
     ...
     * <b>Remind</b> to use the method createReply of the class ACLMessage in
     * order to create a good reply message
     ...
     * the PREPARE_RESPONSE state. This behaviour would override the homonymous
