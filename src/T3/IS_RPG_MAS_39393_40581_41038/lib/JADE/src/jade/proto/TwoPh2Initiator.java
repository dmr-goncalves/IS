...
public class TwoPh2Initiator extends Initiator {
    ...
    /**
     * key to retrieve from the DataStore of the behaviour the vector of
     * ACCEPT_PROPOSAL or REJECT_PROPOSAL messages for which a response has not
     * been received yet.
     */
     ...
     * return a vector of ACCEPT_PROPOSAL or REJECT_PROPOSAL objects for 1:N
     * conversations.
     *
     ...
     * this class. Instead user can specify the <code>reply-by</code> slot
     * representing phase2 timeout.
     */
     ...
     * <code>disconfirm</code> or an <code>inform</code> message is received,
     * which is not out-of-sequence according to the protocol rules. This
     * default implementation does nothing; programmers might wish to override
    ...
    /**
     * This method is called when all the responses have been collected. By
     * response message we intend here all the <code>inform</code> (phase 2),
     * <code>failure</code> (phase 0), <code>disconfirm</code> (phase 1) and
     * <code>inform</code> (phase 1) received messages, which are not
     ...
     * the PREPARE_ACCEPTANCES state. This behaviour would override the
     ...
     * <code>ALL_ACCEPTANCES_KEY</code> key.
     *
    ...
    /**
     * This method allows to register a user defined <code>Behaviour</code> in
     * the HANDLE_OLD_RESPONSE state. This behaviour would override the
     * homonymous method. This method also set the data store of the registered
     * <code>Behaviour</code> to the DataStore of this current behaviour. The
     * registered behaviour can retrieve the
     * <code>failure, disconfirm or inform</code> ACLMessage object received
     ...
     * homonymous method. This method also set the data store of the registered
     * <code>Behaviour</code> to the DataStore of this current behaviour. The
     * registered behaviour can retrieve the vector of ACLMessage received from
     * the datastore at <code>ALL_RESPONSES_RECEIVED_KEY</code>.
     *
     * @param b the Behaviour that will handle this state
     */
     ...
     * <code>inputKey</code> from previouse phase.
     *
     ...
     * Session and removes corresponding accept/reject-proposal from vector of
     * pendings.
     *
