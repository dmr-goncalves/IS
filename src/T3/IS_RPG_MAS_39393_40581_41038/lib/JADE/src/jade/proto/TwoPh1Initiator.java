...
public class TwoPh1Initiator extends Initiator {
    ...
    /**
     * key to retrieve from the DataStore of the behaviour the Vector of CONFIRM
     * messages that have been received as response.
     */
    ...
    /**
     * key to retrieve from the DataStore of the behaviour the Vector of INFORM
     * messages that have been received as response.
     */
     ...
     * <code>accept-proposal</code>, otherwise they are
     ...
     * order to return a vector of QUERY_IF objects for 1:N conversations.
     *
     ...
     * intend here all the <code>disconfirm, confirm, inform</code> received
     * messages, which are not out-of-sequence according to the protocol rules.
     * This default implementation does nothing; programmers might wish to
     ...
     * @param responses prepared responses for next phase:
     ...
     * the PREPARE_QUERYIFS state. This behaviour would override the homonymous
     ...
     * <code>ALL_QUERYIFS_KEY</code> key.
     *
    ...
    /**
     * This method allows to register a user defined <code>Behaviour</code> in
     * the HANDLE_CONFIRM state. This behaviour would override the homonymous
     * method. This method also set the data store of the registered
     * <code>Behaviour</code> to the DataStore of this current behaviour. The
     * registered behaviour can retrieve the <code>confirm</code> ACLMessage
    ...
    /**
     * This method allows to register a user defined <code>Behaviour</code> in
     * the HANDLE_DISCONFIRM state. This behaviour would override the homonymous
     * method. This method also set the data store of the registered
     * <code>Behaviour</code> to the DataStore of this current behaviour. The
     * registered behaviour can retrieve the <code>disconfirm</code> ACLMessage
     * object received from the datastore at the <code>REPLY_KEY</code> key.
     *
     * @param b the Behaviour that will handle this state
     */
     ...
     * <code>Behaviour</code> to the DataStore of this current behaviour. The
     * registered behaviour can retrieve the vector of ACLMessage confirms,
     * disconfirms, informs, pending and responses from the datastore at
     * <code>ALL_CONFIRMS_KEY</code>, <code>ALL_DISCONFIRMS_KEY</code>,
    ...
    /**
     * This method sets for all prepared queryIfs <code>conversation-id</code>
     * slot (with value passed in the constructor), <code>protocol</code> slot
     * and <code>reply-with</code> slot with a unique value constructed by
     * concatenating receiver's agent name and phase number (i.e. 1). After that
     * it sends all cfps.
     *
     ...
     * Session and removes corresponding queryif from vector of pendings.
     *
