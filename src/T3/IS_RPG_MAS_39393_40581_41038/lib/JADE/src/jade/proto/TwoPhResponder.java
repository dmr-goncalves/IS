...
public class TwoPhResponder extends Responder {
     ...
     * message. Take care that if mt is null every message is consumed by this
     * protocol. The best practice is to have a MessageTemplate that matches the
     * protocol slot; the static method <code>createMessageTemplate</code> might
     * be usefull.
     ...
     * <code>PROPOSE, FAILURE</code>. <b>Remind</b> to use the method
     * <code>createReply</code> of the class ACLMessage in order to create a
     * valid reply message
     ...
     * This default implementation return null which has the effect of sending
     * no result notification. Programmers should override the method in case
     * they need to react to this event.
     *
     * @param queryIf the received message
     * @return the ACLMessage to be sent as a result notification (i.e. one of
     * <code>CONFIRM, INFORM, DISCONFIRM</code>. <b>Remind</b> to use the method
     * createReply of the class ACLMessage in order to create a valid reply
     * message
     * @see jade.lang.acl.ACLMessage#createReply()
     *
     */
    ...
    /**
     * This method is called after the <code>REJECT-PROPOSAL</code> has been
     * received. This default implementation do nothing. Programmers should
     ...
     * <code>INFORM</code>. <b>Remind</b> to use the method createReply of the
     * class ACLMessage in order to create a valid reply message
     * @see jade.lang.acl.ACLMessage#createReply()
     *
     */
    ...
    /**
     * This method is called after the <code>ACCEPT-PROPOSAL</code> has been
     * received. This default implementation return null which has the effect of
     * sending no result notification. Programmers should override the method in
     ...
     * the PREPARE_PROPOSE state. This behaviour would override the homonymous
     ...
     * responsibility of the registered behaviour to put the response to be sent
     * into the datastore at the <code>PROPOSE_KEY</code> key.
     *
    ...
    /**
     * This method allows to register a user defined <code>Behaviour</code> in
     * the HANDLE_QUERY_IF state. This behaviour would override the homonymous
     * method. This method also set the data store of the registered
     * <code>Behaviour</code> to the DataStore of this current behaviour. It is
     * responsibility of the registered behaviour to put the response to be sent
     * into the datastore at the <code>REPLY_KEY</code> key.
     *
     * @param b the Behaviour that will handle this state
     *
     */
    ...
    /**
     * This method allows to register a user defined <code>Behaviour</code> in
     * the HANDLE_REJECT state. This behaviour would override the homonymous
     * method. This method also set the data store of the registered
     * <code>Behaviour</code> to the DataStore of this current behaviour. It is
     * responsibility of the registered behaviour to put the response to be sent
     * into the datastore at the <code>REPLY_KEY</code> key.
    ...
    /**
     * This method allows to register a user defined <code>Behaviour</code> in
     * the HANDLE_ACCEPTANCE state. This behaviour would override the homonymous
     * method. This method also set the data store of the registered
     * <code>Behaviour</code> to the DataStore of this current behaviour. It is
     * responsibility of the registered behaviour to put the response to be sent
     * into the datastore at the <code>REPLY_KEY</code> key.
     ...
     * on the interaction protocol and the performative) to be passed to the
     * constructor of this behaviour.
     *
