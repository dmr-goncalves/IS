...
public class SimpleAchieveREInitiator extends SimpleBehaviour {
    ...
    /**
     * key to retrive from the datastore the ACLMessage passed in the
     * constructor
     *
     */
     ...
     * that in this simple implementation, the <code>prepareMessage</code>
     ...
     * the timeout is expired. By response message we intend here all the <code>agree, not-understood,
