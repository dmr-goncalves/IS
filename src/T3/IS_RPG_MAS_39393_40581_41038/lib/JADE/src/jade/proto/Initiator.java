...
abstract class Initiator extends FSMBehaviour {
    ...
    /**
     * Check the global status of the sessions after the reception of the last
     * reply or the expiration of the timeout
     */
     ...
     * that resetting a state before visiting it again is required only if - The
     * onStart() method is redefined - The state has an "internal memory"
     */
    protected abstract String[] getToBeReset();

    /**
     * Return a ProtocolSession object to manage replies to a given initiation
     * message
     */
    ...
    //#APIDOC_EXCLUDE_BEGIN
    /**
     * Attach a behaviour to the <code>Prepare-initiations</code> protocol
     * state.
     *
    ...
    /**
     * This method allows to register a user defined <code>Behaviour</code> in
     * the HANDLE_FAILURE state. This behaviour would override the homonymous
     * method. This method also set the data store of the registered
     * <code>Behaviour</code> to the DataStore of this current behaviour. The
     * registered behaviour can retrieve the <code>failure</code> ACLMessage
    ...
    /**
     * Override the setDataStore() method to propagate this setting to all
     * children.
     */
