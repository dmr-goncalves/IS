...
public class SimpleAchieveREResponder extends SimpleBehaviour implements FIPANames.InteractionProtocol {
     ...
     * <code>agree, refuse, not-understood, inform</code>. <b>Remind</b> to use
     * the method createReply of the class ACLMessage in order to create a good
     * reply message
     ...
     * <code>inform, failure</code>. <b>Remind</b> to use the method createReply
     * of the class ACLMessage in order to create a good reply message
     * @see jade.lang.acl.ACLMessage#createReply()
