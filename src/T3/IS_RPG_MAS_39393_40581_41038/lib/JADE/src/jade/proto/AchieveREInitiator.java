...
public class AchieveREInitiator extends Initiator {
     ...
     * that the default implementation of the <code>prepareRequest()</code>
     ...
     * the PREPARE_REQUESTS state. This behaviour would override the homonymous
     ...
     * <code>ALL_REQUESTS_KEY</code> key. The values of the slot
     * <code>reply-with</code> is ignored and a different value is assigned
     * automatically by this class for each receiver.
     *
