 ...
 * <code>jade.core.behaviours.Behaviour</code>) A number of handlers can be
 * registered with this <code>HandlerSelector</code>, each handler bound to a
 * different key. The abstract method <code>getSelectionKey<code> is then called that
...
public abstract class HandlerSelector extends FSMBehaviour {
    ...
    // States exit values
    /**
     * Value returned by <code>onEnd</code> method if an handler was found
     * mapped to the key
     *
     */
    public static final int SELECTION_OK = 1;
    /**
     * Value returned by <code>onEnd</code> method if no handler was found
     * mapped to the key
     *
     */
     ...
     * this is the object that will be later passed as argument to the method
     * <code>getSelectionKey</code>
     ...
     *
     * @param selectionVar the object retrieved from the datastore at the
     ...
     *
     * @param key this is the key that must be later returned by the method
     * <code>getSelectionKey</code> when the passed Behaviour must be selected
