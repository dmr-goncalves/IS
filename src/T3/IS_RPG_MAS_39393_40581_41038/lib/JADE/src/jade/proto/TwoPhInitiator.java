...
public class TwoPhInitiator extends FSMBehaviour {
     ...
     * that the default implementation of the <code>prepareCfps</code> method
     * returns an array composed of that message only.
     * @param ds <code>DataStore</code> that will be used by this
     * <code>TwoPhInitiator</code>.
     */
     ...
     * <code>reply-with</code> and <code>conversation-id</code> are ignored and
     * regenerated automatically by this class. Instead user can specify
     * <code>reply-by</code> slot representing phase0 timeout.
     */
    protected Vector prepareCfps(ACLMessage cfp) {
    ...
    /**
     * This method is called when all the responses of phase 0 have been
     * collected or when the timeout is expired. The used timeout is the minimum
     * value of the slot <code>reply-By</code> of all the CFP messages sent.By
     * response message we intend here all the
     * <code>propose, failure, not-understood</code> received messages, which
     * are not out-of-sequence according to the protocol rules. This default
     * implementation does nothing; programmers might wish to override this
     * method to modify the Vector of initiation messages
     ...
     *
     * @param responses The Vector of all messages received as response in phase
     * 0
     * @param proposes The Vector of PROPOSE messages received as response in
     * phase 0
    ...
    /**
     * This method is called every time a <code>confirm</code> message is
     * received, which is not out-of-sequence according to the protocol rules.
     * This default implementation does nothing; programmers might wish to
     * override the method in case they need to react to this event.
     *
    ...
    /**
     * This method is called every time a <code>disconfirm</code> message is
     * received, which is not out-of-sequence according to the protocol rules.
     * This default implementation does nothing; programmers might wish to
     * override the method in case they need to react to this event.
     *
    ...
    /**
     * This method is called every time an <code>inform</code> message in phase
     * 1 is received, which is not out-of-sequence according to the protocol
    ...
    /**
     * This method is called in phase 1 when all the responses have been
     * collected or when the timeout is expired. The used timeout is the minimum
     * value of the slot <code>reply-By</code> of all the sent messages. By
     * response message we intend here all the
     * <code>disconfirm, confirm, inform</code> received messages, which are not
     ...
     * @param nextPhMsgs prepared responses for next phase:
     * <code>accept-proposal</code> or <code>reject-proposal</code>
     */
    ...
    /**
     * This method is called every time an <code>inform</code> message in phase
     * 2 is received, which is not out-of-sequence according to the protocol
     * rules. This default implementation does nothing; programmers might wish
     * to override the method in case they need to react to this event.
     *
     * @param inform the received propose message
    ...
    /**
     * This method is called every time a <code>failure</code>, a
     * <code>disconfirm</code> or an <code>inform</code> message is received in
     * phase 2, which is not out-of-sequence according to the protocol rules.
     * This default implementation does nothing; programmers might wish to
     * override the method in case they need to react to this event.
     *
    ...
    /**
     * This method is called in phase 2 when all the responses have been
     * collected. By response message we intend here all the <code>inform</code>
     * (phase 2), <code>failure</code> (phase 0), <code>disconfirm</code> (phase
     * 1) and <code>inform</code> (phase 1) received messages, which are not
     * out-of-sequence according to the protocol rules. This default
     * implementation does nothing; programmers might wish to override the
     * method in case they need to react to this event by analysing all the
     * messages in just one call.
