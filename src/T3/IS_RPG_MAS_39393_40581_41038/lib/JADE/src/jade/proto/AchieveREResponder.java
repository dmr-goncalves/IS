...
public class AchieveREResponder extends FSMBehaviour implements FIPANames.InteractionProtocol {
     ...
     * on the interaction protocol and the performative) into the constructor of
     * this behaviour.
     *
    ...
    /**
     * This method allows to change the <code>MessageTemplate</code> that
     * defines what messages this FIPARequestResponder will react to and reset
     * the protocol.
     */
     ...
     * MessageTemplate specified in the constructor) is received. This default
     * implementation returns null which has the effect of sending no reponse.
     * Programmers should override this method in case they need to react to
     * this event.
     *
    ...
    /**
     * This method is called after the execution of the handleRequest() method
     * if no response was sent or the response was an <code>AGREE</code>
     * message. This default implementation returns null which has the effect of
     ...
     * method. This method also set the DataStore of the registered
     * <code>Behaviour</code> to the DataStore of this AchieveREResponder. It is
     * responsibility of the registered behaviour to put the response to be sent
     * into the DataStore at the <code>RESPONSE_KEY</code> key.
     *
    ...
    /**
     * This method allows to register a user defined <code>Behaviour</code> in
     * the PREPARE_RESULT_NOTIFICATION state. This behaviour would override the
     * homonymous method. This method also set the DataStore of the registered
     * <code>Behaviour</code> to the DataStore of this AchieveREResponder. It is
     * responsibility of the registered behaviour to put the result notification
     * message to be sent into the DataStore at the
