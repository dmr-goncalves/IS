...
public class ISO8601 {
     ...
     * 'true' generates tokens using UTC time, 'false' using local time. If you
     * need to send messages to agents compiled with older versions of Jade,
     * then set this to <code>false</code>.
