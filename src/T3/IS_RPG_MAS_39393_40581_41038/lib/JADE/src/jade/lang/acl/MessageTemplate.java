 ...
 * @version $Date: 2008-10-09 14:07:18 +0200 (gio, 09 ott 2008) $ $Revision:
 * 6052 $
 *
 */
public class MessageTemplate implements Serializable {
     ...
     * specific MessageTemplate. In particular in the method
     * <code> match()</code> the programmer should realize the necessary checks
     * on the ACLMessage in order to return <b>true</b> if the message match
     * with the application specific requirements <b>false</b> otherwise.
     */
    public static interface MatchExpression extends Serializable {
         ...
         * implementations of this interface will have this method called to
         * accept or refuse an ACL message.
         *
         * @param msg The ACL message to match against this message template.
         * @return A compliant implementation will return <code>true</code> if
         * the parameter ACL message matches the template, and
     ...
     *
     * @param values An array of Agent IDs against which the value of the
     * message slot will be matched.
     * @return A new <code>MessageTemplate</code> matching the given value.
     */
     ...
     * @return A new <code>MessageTemplate</code> matching messages about the
     * given topic
     */
     ...
     *
     * @param value The <code>Date</code> the message slot will be matched
     * against.
     * @return A new <code>MessageTemplate</code> matching the given value.
     *
     */
     ...
     * messages against a given one, passed as parameter. The following
     * algorithm is used: When the given <code>ACLMessage</code> has a non
     * <code>null</code> slot, subsequent messages must have the same slot value
     * in that slot to have a match. When the given <code>ACLMessage</code> has
     * a <code>null</code> slot, subsequent messages can have any value for that
     * slot and still match the template. In short, a <code>null</code> value
     * for a slot means <em>don't care</em>.
     *
     * @param msg The <code>ACLMessage</code> used to build a custom message
     * template.
     * @param matchPerformative a <code>bool</code> value. When
     * <code>true</code>, the performative of the <code>msg</code> will be
     * considered as a part of the template (i.e. the message template will
     * match only ACL messages with the same performativa as <code>msg</code>).
     * When <false>, the performative of <code>msg</code> is ignored and the
     * resulting message template will not consider it when matching messages.
     ...
     * method creates a new message template that is matched by those ACL
     * messages matching <b><em>both</b></em>
     ...
     * @see jade.lang.acl.MessageTemplate#or(MessageTemplate op1,
     * MessageTemplate op2)
     */
     ...
     * method creates a new message template that is matched by those ACL
     * messages matching <b><em>any</b></em> of the two message templates given
     * as operands.
     *
     * @param op1 The first <em>or</em> operand.
     * @param op2 The second <em>or</em> operand.
     * @return A new <code>MessageTemplate</code> object.
     * @see jade.lang.acl.MessageTemplate#and(MessageTemplate op1,
     * MessageTemplate op2)
     */
     ...
     *
     * @return A string describing the syntactic structure of this message
     * template.
     */
    public String toString() {
