...
public class StringACLCodec implements ACLCodec {
    ...
    /**
     * String constant for the name of the ACL representation managed by this
     * ACL codec.
     */
    ...
    /**
     * constructor for the codec. The standard input is used as an input stream
     * of ACL messages. The standard output is used to write encoded ACL
     * messages.
     */
     ...
     * <code>new InputStreamReader(System.in)</code> if you want to use the
     * standard input)
     * @parameter w is the writer to write encoded ACL messages (pass
     * <code>new OutputStreamWriter(System.out)</code> if you want to use the
     * standard output)
     */
    ...
    /**
     * Parse an agent identifier, without it being included within an ACL
     * message.
     */
     ...
     * constructor. Notice that this method does not call <code>flush</code> on
     * the writer.
     *
     ...
     * quotation marks to the beginning/end and escape any quotation marks
     * inside the string.
     */
    ...
    /**
     * If a user-defined parameter contain a blank char inside, then it is
     * skipped for FIPA-compatibility
     *
    ...
    /**
     * If the content of the message is a byteSequence, then this method encodes
     * the content in Base64 and automatically sets the value of the encoding
     * slot.
     *
     ...
     * blank char and followed by a newline. If the value contains a blank, then
     * it is quoted. if the value is null or its length is zero, the method does
     * nothing.
     *
     */
    ...
    /**
     * Test if the given string is a legal word using the FIPA ACL spec. In
     * addition to FIPA's restrictions, place the additional restriction that a
     * Word can not contain a '\"', that would confuse the parser at the other
     * end.
     */
