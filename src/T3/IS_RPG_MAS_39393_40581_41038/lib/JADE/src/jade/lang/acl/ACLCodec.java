...
public interface ACLCodec {
  ...
  #DOTNET_INCLUDE_END*/
     ...
     * subsystem accessed through this interface. If an exception is thrown by
     * the underlying parser, it is wrapped with a
     * <code>Codec.CodecException</code>, which is then rethrown.
     */
    public static class CodecException extends Exception {
         ...
         * thrown by the concrete parsing subsystem.
         */
        ...
        /**
         * Print the stack trace for this exception on the standard output
         * stream.
         */
    ...
    /**
     * Encodes an <code>ACLMessage</code> object into a byte sequence, according
     * to the specific message representation.
     *
