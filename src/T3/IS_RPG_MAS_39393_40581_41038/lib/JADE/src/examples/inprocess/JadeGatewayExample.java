...
/**
 * This class provides a simple example of a NON-jade program that connects to a
 * running JADE-based system using the JadeGateway class. In order to try this
 * example
 * <ol>
 * <li>Be sure the JADE examples are compiled</li>
 * <li>Be sure the JADE libraries (jade/lib/jade.jar) and the JADE examples
 * classes (jade/classes) are in the classpath</li>
 * <li>Open a shell and start a JADE main container typing
 * <code>java jade.Boot -gui</code>. This represents the running JADE-based
 * system we have to connect to</li>
 * <li>Open another shell and start this example typing
 * <code>java examples.inprocess.JadeGatewayExample</code>.</li>
 * </ol>
 */
public class JadeGatewayExample {
    ...
    /**
     * Inner class MainContainerAgentsRetriever. This behaviour requests the AMS
     * the list of agents running in the Main Container
     */
