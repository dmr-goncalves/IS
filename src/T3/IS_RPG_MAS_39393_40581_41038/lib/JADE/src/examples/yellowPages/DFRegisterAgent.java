...
/**
 * This example shows how to register an application specific service in the
 * Yellow Pages catalogue managed by the DF Agent so that other agents can
 * dynamically discover it. In this case in particular we register a
 * "Weather-forecast" service for Italy. The name of this service is specified
