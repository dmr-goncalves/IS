 ...
 *
 * <b>Note:</b>
 * While entering input data, all fields composed of more than one word must be
 * enclosed in "". E.g. the name Giovanni Caire must be entered as "Giovanni
 * Caire".
 *
...
public class RequesterAgent extends Agent {
    ...
    // AGENT BEHAVIOURS
    /**
     * Main behaviour for the Requester Agent. First the details of a person to
     ...
     * requested. This behaviour is executed cyclically.
     */
    ...
    /**
     * This behaviour embeds the check that the indicated person is not already
    ...
    /**
     * This behaviour embeds the request to engage the indicated person in the
