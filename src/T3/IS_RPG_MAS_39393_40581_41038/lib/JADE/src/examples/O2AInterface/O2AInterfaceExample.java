...
/**
 * This class shows an example of how to run JADE as a library from an external
 * program and in particular how to start an agent and interact with it by means
 * of the Object-to-Agent (O2A) interface.
 *
