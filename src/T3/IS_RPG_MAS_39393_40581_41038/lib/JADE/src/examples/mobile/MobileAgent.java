...
/**
 * This is an example of mobile agent. This class contains the resources used by
 * the agent behaviours: the counter, the flag cntEnabled, and the list of
 * visited locations. At the setup it creates a gui and adds behaviours to: get
 * the list of available locations from AMS, serve the incoming messages, and to
 * increment the counter. In particular, notice the usage of the two methods
 * <code>beforeMove()</code> and <code>afterMove()</code> to execute some
 ...
 * @version $Date: 2004-08-20 12:15:13 +0200 (ven, 20 ago 2004) $ $Revision:
 * 5283 $
 */
public class MobileAgent extends GuiAgent {
     ...
     * It is automatically called by the JADE framework. It disposes the GUI and
     * prints a bye message on the standard output.
     */
     ...
     * destination. It creates a new GUI and sets the list of visited locations
     * and the list of available locations (via the behaviour) in the GUI.
     */
