 ...
 * (move <destination>) to move the Agent to another container. Example (move
 * Front-End) or (move (:location (:name Container-1) (:transport-protocol
 * JADE-IPMT) (:transport-address IOR:0000...) )) - (exit) to request the agent
 * to exit - (stop) to stop the counter - (continue) to continue counting
 *
