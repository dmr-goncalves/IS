...
/**
 * The behaviour uses two resources, in particular the counter cnt and the flag
 * cntEnabled, of the agent object. It increments by one its value, displays it,
 * blocks for two seconds, and repeats forever.
 *
 * @author Giovanni Caire - CSELT S.p.A
 * @version $Date: 2002-07-16 11:20:11 +0200 (mar, 16 lug 2002) $ $Revision:
 * 3271 $
 */
